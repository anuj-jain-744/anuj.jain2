...
`;let ej=new WeakMap;function eV(t,e){return function(o,n,r){let a=ej.get(o.constructor);null==a&&ej.set(o.constructor,a=[]),a.push({method:r.value,keys:Array.isArray(t)?t:[t],afterFirstUpdate:e?.afterFirstUpdate??!1})}}let GlElement=class GlElement extends lit_element_i{emit(t,e,o){let n=new CustomEvent(t,{bubbles:!0,cancelable:!1,composed:!0,...o,detail:e});return this.dispatchEvent(n),n}update(t){let e=ej.get(this.constructor);if(null!=e)for(let{keys:o,method:n,afterFirstUpdate:r}of e){if(r&&!this.hasUpdated)continue;let e=o.filter(e=>t.has(e));e.length&&n.call(this,e)}super.update(t)}};var eZ=tV`
  :host {
...
`;let eW=new Set,eG=new Map,eY="ltr",eK="en",eJ="undefined"!=typeof MutationObserver&&"undefined"!=typeof document&&void 0!==document.documentElement;if(eJ){let t=new MutationObserver(eX);eY=document.documentElement.dir||"ltr",eK=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function eQ(...t){t.map(t=>{let e=t.$code.toLowerCase();eG.has(e)?eG.set(e,Object.assign(Object.assign({},eG.get(e)),t)):eG.set(e,t),n||(n=t)}),eX()}function eX(){eJ&&(eY=document.documentElement.dir||"ltr",eK=document.documentElement.lang||navigator.language),[...eW.keys()].map(t=>{"function"==typeof t.requestUpdate&&t.requestUpdate()})}let LocalizeController=class LocalizeController{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){eW.add(this.host)}hostDisconnected(){eW.delete(this.host)}dir(){return`${this.host.dir||eY}`.toLowerCase()}lang(){return`${this.host.lang||eK}`.toLowerCase()}getTranslationData(t){var e,o;let n=new Intl.Locale(t.replace(/_/g,"-")),r=null==n?void 0:n.language.toLowerCase(),a=null!=(o=null==(e=null==n?void 0:n.region)?void 0:e.toLowerCase())?o:"",l=eG.get(`${r}-${a}`),c=eG.get(r);return{locale:n,language:r,region:a,primary:l,secondary:c}}exists(t,e){var o;let{primary:r,secondary:a}=this.getTranslationData(null!=(o=e.lang)?o:this.lang());return e=Object.assign({includeFallback:!1},e),!!r&&!!r[t]||!!a&&!!a[t]||!!e.includeFallback&&!!n&&!!n[t]}term(t,...e){let o,{primary:r,secondary:a}=this.getTranslationData(this.lang());if(r&&r[t])o=r[t];else if(a&&a[t])o=a[t];else{if(!n||!n[t])return String(t);o=n[t]}return"function"==typeof o?o(...e):o}date(t,e){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),e).format(t)}number(t,e){return isNaN(t=Number(t))?"":new Intl.NumberFormat(this.lang(),e).format(t)}relativeTime(t,e,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(t,e)}};var e1={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>0===t?"No options selected":1===t?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};eQ(e1);var e2=class extends LocalizeController{};eQ(e1);var e0=tV`
  :host {
    box-sizing: border-box;
  }
...
`,e3=Object.defineProperty,e5=Object.defineProperties,e8=Object.getOwnPropertyDescriptor,e9=Object.getOwnPropertyDescriptors,e7=Object.getOwnPropertySymbols,e4=Object.prototype.hasOwnProperty,e6=Object.prototype.propertyIsEnumerable,it=t=>{throw TypeError(t)},ie=(t,e,o)=>e in t?e3(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,ii=(t,e)=>{for(var o in e||(e={}))e4.call(e,o)&&ie(t,o,e[o]);if(e7)for(var o of e7(e))e6.call(e,o)&&ie(t,o,e[o]);return t},io=(t,e)=>e5(t,e9(e)),is=(t,e,o,n)=>{for(var r,a=n>1?void 0:n?e8(e,o):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(n?r(e,o,a):r(a))||a);return n&&a&&e3(e,o,a),a},ir=(t,e,o)=>e.has(t)||it("Cannot "+o),ia=(t,e,o)=>(ir(t,e,"read from private field"),o?o.call(t):e.get(t)),il=(t,e,o)=>e.has(t)?it("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o),ic=(t,e,o,n)=>(ir(t,e,"write to private field"),n?n.call(t,o):e.set(t,o),o),ih=class extends lit_element_i{constructor(){super(),il(this,u,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,e])=>{this.constructor.define(t,e)})}emit(t,e){let o=new CustomEvent(t,ii({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(o),o}static define(t,e=this,o={}){let n=customElements.get(t);if(!n){try{customElements.define(t,e,o)}catch(n){customElements.define(t,class extends e{},o)}return}let r=" (unknown version)",a=r;if("version"in e&&e.version&&(r=" v"+e.version),"version"in n&&n.version&&(a=" v"+n.version),r&&a&&r===a)return}attributeChangedCallback(t,e,o){ia(this,u)||(this.constructor.elementProperties.forEach((t,e)=>{t.reflect&&null!=this[e]&&this.initialReflectedProperties.set(e,this[e])}),ic(this,u,!0)),super.attributeChangedCallback(t,e,o)}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((e,o)=>{t.has(o)&&null==this[o]&&(this[o]=e)})}};u=new WeakMap,ih.version="2.20.1",ih.dependencies={},is([eD()],ih.prototype,"dir",2),is([eD()],ih.prototype,"lang",2);let id=Math.min,ip=Math.max,iu=Math.round,ig=Math.floor,im=t=>({x:t,y:t}),iv={left:"right",right:"left",bottom:"top",top:"bottom"},ib={start:"end",end:"start"};function iy(t,e){return"function"==typeof t?t(e):t}function iw(t){return t.split("-")[0]}function i_(t){return t.split("-")[1]}function iC(t){return"x"===t?"y":"x"}function i$(t){return"y"===t?"height":"width"}function ix(t){return["top","bottom"].includes(iw(t))?"y":"x"}function ik(t){return t.replace(/start|end/g,t=>ib[t])}function iS(t){return t.replace(/left|right|bottom|top/g,t=>iv[t])}function iA(t){return"number"!=typeof t?{top:0,right:0,bottom:0,left:0,...t}:{top:t,right:t,bottom:t,left:t}}function iL(t){let{x:e,y:o,width:n,height:r}=t;return{width:n,height:r,top:o,left:e,right:e+n,bottom:o+r,x:e,y:o}}function iP(t,e,o){let n,{reference:r,floating:a}=t,l=ix(e),c=iC(ix(e)),h=i$(c),d=iw(e),p="y"===l,u=r.x+r.width/2-a.width/2,g=r.y+r.height/2-a.height/2,f=r[h]/2-a[h]/2;switch(d){case"top":n={x:u,y:r.y-a.height};break;case"bottom":n={x:u,y:r.y+r.height};break;case"right":n={x:r.x+r.width,y:g};break;case"left":n={x:r.x-a.width,y:g};break;default:n={x:r.x,y:r.y}}switch(i_(e)){case"start":n[c]-=f*(o&&p?-1:1);break;case"end":n[c]+=f*(o&&p?-1:1)}return n}let iE=async(t,e,o)=>{let{placement:n="bottom",strategy:r="absolute",middleware:a=[],platform:l}=o,c=a.filter(Boolean),h=await (null==l.isRTL?void 0:l.isRTL(e)),d=await l.getElementRects({reference:t,floating:e,strategy:r}),{x:p,y:u}=iP(d,n,h),g=n,f={},m=0;for(let o=0;o<c.length;o++){let{name:a,fn:v}=c[o],{x:b,y:w,data:_,reset:C}=await v({x:p,y:u,initialPlacement:n,placement:g,strategy:r,middlewareData:f,rects:d,platform:l,elements:{reference:t,floating:e}});p=null!=b?b:p,u=null!=w?w:u,f={...f,[a]:{...f[a],..._}},C&&m<=50&&(m++,"object"==typeof C&&(C.placement&&(g=C.placement),C.rects&&(d=!0===C.rects?await l.getElementRects({reference:t,floating:e,strategy:r}):C.rects),{x:p,y:u}=iP(d,g,h)),o=-1)}return{x:p,y:u,placement:g,strategy:r,middlewareData:f}};async function iM(t,e){var o;void 0===e&&(e={});let{x:n,y:r,platform:a,rects:l,elements:c,strategy:h}=t,{boundary:d="clippingAncestors",rootBoundary:p="viewport",elementContext:u="floating",altBoundary:g=!1,padding:f=0}=iy(e,t),m=iA(f),v=c[g?"floating"===u?"reference":"floating":u],b=iL(await a.getClippingRect({element:null==(o=await (null==a.isElement?void 0:a.isElement(v)))||o?v:v.contextElement||await (null==a.getDocumentElement?void 0:a.getDocumentElement(c.floating)),boundary:d,rootBoundary:p,strategy:h})),w="floating"===u?{x:n,y:r,width:l.floating.width,height:l.floating.height}:l.reference,_=await (null==a.getOffsetParent?void 0:a.getOffsetParent(c.floating)),C=await (null==a.isElement?void 0:a.isElement(_))&&await (null==a.getScale?void 0:a.getScale(_))||{x:1,y:1},$=iL(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:w,offsetParent:_,strategy:h}):w);return{top:(b.top-$.top+m.top)/C.y,bottom:($.bottom-b.bottom+m.bottom)/C.y,left:(b.left-$.left+m.left)/C.x,right:($.right-b.right+m.right)/C.x}}async function iT(t,e){let{placement:o,platform:n,elements:r}=t,a=await (null==n.isRTL?void 0:n.isRTL(r.floating)),l=iw(o),c=i_(o),h="y"===ix(o),d=["left","top"].includes(l)?-1:1,p=a&&h?-1:1,u=iy(e,t),{mainAxis:g,crossAxis:f,alignmentAxis:m}="number"==typeof u?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return c&&"number"==typeof m&&(f="end"===c?-1*m:m),h?{x:f*p,y:g*d}:{x:g*d,y:f*p}}function iR(){return"undefined"!=typeof window}function iD(t){return iN(t)?(t.nodeName||"").toLowerCase():"#document"}function iO(t){var e;return(null==t||null==(e=t.ownerDocument)?void 0:e.defaultView)||window}function iI(t){var e;return null==(e=(iN(t)?t.ownerDocument:t.document)||window.document)?void 0:e.documentElement}function iN(t){return!!iR()&&(t instanceof Node||t instanceof iO(t).Node)}function iH(t){return!!iR()&&(t instanceof Element||t instanceof iO(t).Element)}function iB(t){return!!iR()&&(t instanceof HTMLElement||t instanceof iO(t).HTMLElement)}function iz(t){return!!iR()&&"undefined"!=typeof ShadowRoot&&(t instanceof ShadowRoot||t instanceof iO(t).ShadowRoot)}function iF(t){let{overflow:e,overflowX:o,overflowY:n,display:r}=iZ(t);return/auto|scroll|overlay|hidden|clip/.test(e+n+o)&&!["inline","contents"].includes(r)}function iU(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function iq(t){let e=ij(),o=iH(t)?iZ(t):t;return["transform","translate","scale","rotate","perspective"].some(t=>!!o[t]&&"none"!==o[t])||!!o.containerType&&"normal"!==o.containerType||!e&&!!o.backdropFilter&&"none"!==o.backdropFilter||!e&&!!o.filter&&"none"!==o.filter||["transform","translate","scale","rotate","perspective","filter"].some(t=>(o.willChange||"").includes(t))||["paint","layout","strict","content"].some(t=>(o.contain||"").includes(t))}function ij(){return"undefined"!=typeof CSS&&!!CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")}function iV(t){return["html","body","#document"].includes(iD(t))}function iZ(t){return iO(t).getComputedStyle(t)}function iW(t){return iH(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function iG(t){if("html"===iD(t))return t;let e=t.assignedSlot||t.parentNode||iz(t)&&t.host||iI(t);return iz(e)?e.host:e}function iY(t,e,o){var n;void 0===e&&(e=[]),void 0===o&&(o=!0);let r=function t(e){let o=iG(e);return iV(o)?e.ownerDocument?e.ownerDocument.body:e.body:iB(o)&&iF(o)?o:t(o)}(t),a=r===(null==(n=t.ownerDocument)?void 0:n.body),l=iO(r);if(a){let t=iK(l);return e.concat(l,l.visualViewport||[],iF(r)?r:[],t&&o?iY(t):[])}return e.concat(r,iY(r,[],o))}function iK(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function iJ(t){let e=iZ(t),o=parseFloat(e.width)||0,n=parseFloat(e.height)||0,r=iB(t),a=r?t.offsetWidth:o,l=r?t.offsetHeight:n,c=iu(o)!==a||iu(n)!==l;return c&&(o=a,n=l),{width:o,height:n,$:c}}function iQ(t){return iH(t)?t:t.contextElement}function iX(t){let e=iQ(t);if(!iB(e))return im(1);let o=e.getBoundingClientRect(),{width:n,height:r,$:a}=iJ(e),l=(a?iu(o.width):o.width)/n,c=(a?iu(o.height):o.height)/r;return l&&Number.isFinite(l)||(l=1),c&&Number.isFinite(c)||(c=1),{x:l,y:c}}let i1=im(0);function i2(t){let e=iO(t);return ij()&&e.visualViewport?{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}:i1}function i0(t,e,o,n){var r;void 0===e&&(e=!1),void 0===o&&(o=!1);let a=t.getBoundingClientRect(),l=iQ(t),c=im(1);e&&(n?iH(n)&&(c=iX(n)):c=iX(t));let h=(void 0===(r=o)&&(r=!1),n&&(!r||n===iO(l))&&r)?i2(l):im(0),d=(a.left+h.x)/c.x,p=(a.top+h.y)/c.y,u=a.width/c.x,g=a.height/c.y;if(l){let t=iO(l),e=n&&iH(n)?iO(n):n,o=t,r=iK(o);for(;r&&n&&e!==o;){let t=iX(r),e=r.getBoundingClientRect(),n=iZ(r),a=e.left+(r.clientLeft+parseFloat(n.paddingLeft))*t.x,l=e.top+(r.clientTop+parseFloat(n.paddingTop))*t.y;d*=t.x,p*=t.y,u*=t.x,g*=t.y,d+=a,p+=l,r=iK(o=iO(r))}}return iL({width:u,height:g,x:d,y:p})}function i3(t,e){let o=iW(t).scrollLeft;return e?e.left+o:i0(iI(t)).left+o}function i5(t,e,o){void 0===o&&(o=!1);let n=t.getBoundingClientRect();return{x:n.left+e.scrollLeft-(o?0:i3(t,n)),y:n.top+e.scrollTop}}function i8(t,e,o){let n;if("viewport"===e)n=function(t,e){let o=iO(t),n=iI(t),r=o.visualViewport,a=n.clientWidth,l=n.clientHeight,c=0,h=0;if(r){a=r.width,l=r.height;let t=ij();(!t||t&&"fixed"===e)&&(c=r.offsetLeft,h=r.offsetTop)}return{width:a,height:l,x:c,y:h}}(t,o);else if("document"===e)n=function(t){let e=iI(t),o=iW(t),n=t.ownerDocument.body,r=ip(e.scrollWidth,e.clientWidth,n.scrollWidth,n.clientWidth),a=ip(e.scrollHeight,e.clientHeight,n.scrollHeight,n.clientHeight),l=-o.scrollLeft+i3(t),c=-o.scrollTop;return"rtl"===iZ(n).direction&&(l+=ip(e.clientWidth,n.clientWidth)-r),{width:r,height:a,x:l,y:c}}(iI(t));else if(iH(e))n=function(t,e){let o=i0(t,!0,"fixed"===e),n=o.top+t.clientTop,r=o.left+t.clientLeft,a=iB(t)?iX(t):im(1),l=t.clientWidth*a.x,c=t.clientHeight*a.y;return{width:l,height:c,x:r*a.x,y:n*a.y}}(e,o);else{let o=i2(t);n={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return iL(n)}function i9(t){return"static"===iZ(t).position}function i7(t,e){if(!iB(t)||"fixed"===iZ(t).position)return null;if(e)return e(t);let o=t.offsetParent;return iI(t)===o&&(o=o.ownerDocument.body),o}function i4(t,e){let o=iO(t);if(iU(t))return o;if(!iB(t)){let e=iG(t);for(;e&&!iV(e);){if(iH(e)&&!i9(e))return e;e=iG(e)}return o}let n=i7(t,e);for(;n&&["table","td","th"].includes(iD(n))&&i9(n);)n=i7(n,e);return n&&iV(n)&&i9(n)&&!iq(n)?o:n||function(t){let e=iG(t);for(;iB(e)&&!iV(e);){if(iq(e))return e;if(iU(e))break;e=iG(e)}return null}(t)||o}let i6=async function(t){let e=this.getOffsetParent||i4,o=this.getDimensions,n=await o(t.floating);return{reference:function(t,e,o){let n=iB(e),r=iI(e),a="fixed"===o,l=i0(t,!0,a,e),c={scrollLeft:0,scrollTop:0},h=im(0);if(n||!n&&!a)if(("body"!==iD(e)||iF(r))&&(c=iW(e)),n){let t=i0(e,!0,a,e);h.x=t.x+e.clientLeft,h.y=t.y+e.clientTop}else r&&(h.x=i3(r));a&&!n&&r&&(h.x=i3(r));let d=!r||n||a?im(0):i5(r,c);return{x:l.left+c.scrollLeft-h.x-d.x,y:l.top+c.scrollTop-h.y-d.y,width:l.width,height:l.height}}(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}},ot={convertOffsetParentRelativeRectToViewportRelativeRect:function(t){let{elements:e,rect:o,offsetParent:n,strategy:r}=t,a="fixed"===r,l=iI(n),c=!!e&&iU(e.floating);if(n===l||c&&a)return o;let h={scrollLeft:0,scrollTop:0},d=im(1),p=im(0),u=iB(n);if((u||!u&&!a)&&(("body"!==iD(n)||iF(l))&&(h=iW(n)),iB(n))){let t=i0(n);d=iX(n),p.x=t.x+n.clientLeft,p.y=t.y+n.clientTop}let g=!l||u||a?im(0):i5(l,h,!0);return{width:o.width*d.x,height:o.height*d.y,x:o.x*d.x-h.scrollLeft*d.x+p.x+g.x,y:o.y*d.y-h.scrollTop*d.y+p.y+g.y}},getDocumentElement:iI,getClippingRect:function(t){let{element:e,boundary:o,rootBoundary:n,strategy:r}=t,a=[..."clippingAncestors"===o?iU(e)?[]:function(t,e){let o=e.get(t);if(o)return o;let n=iY(t,[],!1).filter(t=>iH(t)&&"body"!==iD(t)),r=null,a="fixed"===iZ(t).position,l=a?iG(t):t;for(;iH(l)&&!iV(l);){let e=iZ(l),o=iq(l);o||"fixed"!==e.position||(r=null),(a?!o&&!r:!o&&"static"===e.position&&!!r&&["absolute","fixed"].includes(r.position)||iF(l)&&!o&&function t(e,o){let n=iG(e);return!(n===o||!iH(n)||iV(n))&&("fixed"===iZ(n).position||t(n,o))}(t,l))?n=n.filter(t=>t!==l):r=e,l=iG(l)}return e.set(t,n),n}(e,this._c):[].concat(o),n],l=a[0],c=a.reduce((t,o)=>{let n=i8(e,o,r);return t.top=ip(n.top,t.top),t.right=id(n.right,t.right),t.bottom=id(n.bottom,t.bottom),t.left=ip(n.left,t.left),t},i8(e,l,r));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},getOffsetParent:i4,getElementRects:i6,getClientRects:function(t){return Array.from(t.getClientRects())},getDimensions:function(t){let{width:e,height:o}=iJ(t);return{width:e,height:o}},getScale:iX,isElement:iH,isRTL:function(t){return"rtl"===iZ(t).direction}};function oe(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}let oi=function(t){return void 0===t&&(t={}),{name:"size",options:t,async fn(e){var o,n;let r,a,{placement:l,rects:c,platform:h,elements:d}=e,{apply:p=()=>{},...u}=iy(t,e),g=await iM(e,u),f=iw(l),m=i_(l),v="y"===ix(l),{width:b,height:w}=c.floating;"top"===f||"bottom"===f?(r=f,a=m===(await (null==h.isRTL?void 0:h.isRTL(d.floating))?"start":"end")?"left":"right"):(a=f,r="end"===m?"top":"bottom");let _=w-g.top-g.bottom,C=b-g.left-g.right,$=id(w-g[r],_),x=id(b-g[a],C),S=!e.middlewareData.shift,A=$,P=x;if(null!=(o=e.middlewareData.shift)&&o.enabled.x&&(P=C),null!=(n=e.middlewareData.shift)&&n.enabled.y&&(A=_),S&&!m){let t=ip(g.left,0),e=ip(g.right,0),o=ip(g.top,0),n=ip(g.bottom,0);v?P=b-2*(0!==t||0!==e?t+e:ip(g.left,g.right)):A=w-2*(0!==o||0!==n?o+n:ip(g.top,g.bottom))}await p({...e,availableWidth:P,availableHeight:A});let E=await h.getDimensions(d.floating);return b!==E.width||w!==E.height?{reset:{rects:!0}}:{}}}},oo=t=>({name:"arrow",options:t,async fn(e){let{x:o,y:n,placement:r,rects:a,platform:l,elements:c,middlewareData:h}=e,{element:d,padding:p=0}=iy(t,e)||{};if(null==d)return{};let u=iA(p),g={x:o,y:n},f=iC(ix(r)),m=i$(f),v=await l.getDimensions(d),b="y"===f,w=b?"clientHeight":"clientWidth",_=a.reference[m]+a.reference[f]-g[f]-a.floating[m],C=g[f]-a.reference[f],$=await (null==l.getOffsetParent?void 0:l.getOffsetParent(d)),x=$?$[w]:0;x&&await (null==l.isElement?void 0:l.isElement($))||(x=c.floating[w]||a.floating[m]);let S=x/2-v[m]/2-1,A=id(u[b?"top":"left"],S),P=id(u[b?"bottom":"right"],S),E=x-v[m]-P,T=x/2-v[m]/2+(_/2-C/2),D=ip(A,id(T,E)),O=!h.arrow&&null!=i_(r)&&T!==D&&a.reference[m]/2-(T<A?A:P)-v[m]/2<0,B=O?T<A?T-A:T-E:0;return{[f]:g[f]+B,data:{[f]:D,centerOffset:T-D-B,...O&&{alignmentOffset:B}},reset:O}}}),os=(t,e,o)=>{let n=new Map,r={platform:ot,...o},a={...r.platform,_c:n};return iE(t,e,{...r,platform:a})},on=t=>(...e)=>({_$litDirective$:t,values:e});let directive_i=class directive_i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,o){this._$Ct=t,this._$AM=e,this._$Ci=o}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};let or=on(class extends directive_i{constructor(t){if(super(t),1!==t.type||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){for(let o in this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t))),e)e[o]&&!this.nt?.has(o)&&this.st.add(o);return this.render(e)}let o=t.element.classList;for(let t of this.st)t in e||(o.remove(t),this.st.delete(t));for(let t in e){let n=!!e[t];n===this.st.has(t)||this.nt?.has(t)||(n?(o.add(t),this.st.add(t)):(o.remove(t),this.st.delete(t)))}return ew}});function oa(t){var e=t;for(let t=e;t;t=ol(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=ol(e);t;t=ol(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if("contents"!==e.display&&("static"!==e.position||iq(e)||"BODY"===t.tagName))return t}return null}function ol(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}var oc=class extends ih{constructor(){super(...arguments),this.localize=new e2(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),o=this.placement.includes("top")||this.placement.includes("bottom"),n=0,r=0,a=0,l=0,c=0,h=0,d=0,p=0;o?t.top<e.top?(n=t.left,r=t.bottom,a=t.right,l=t.bottom,c=e.left,h=e.top,d=e.right,p=e.top):(n=e.left,r=e.bottom,a=e.right,l=e.bottom,c=t.left,h=t.top,d=t.right,p=t.top):t.left<e.left?(n=t.right,r=t.top,a=e.left,l=e.top,c=t.right,h=t.bottom,d=e.left,p=e.bottom):(n=e.right,r=e.top,a=t.left,l=t.top,c=e.right,h=e.bottom,d=t.left,p=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${n}px`),this.style.setProperty("--hover-bridge-top-left-y",`${r}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else{var t;this.anchor instanceof Element||null!==(t=this.anchor)&&"object"==typeof t&&"getBoundingClientRect"in t&&(!("contextElement"in t)||t.contextElement instanceof Element)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]')}this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=function(t,e,o,n){let r;void 0===n&&(n={});let{ancestorScroll:a=!0,ancestorResize:l=!0,elementResize:c="function"==typeof ResizeObserver,layoutShift:h="function"==typeof IntersectionObserver,animationFrame:d=!1}=n,p=iQ(t),u=a||l?[...p?iY(p):[],...iY(e)]:[];u.forEach(t=>{a&&t.addEventListener("scroll",o,{passive:!0}),l&&t.addEventListener("resize",o)});let g=p&&h?function(t,e){let o,n=null,r=iI(t);function a(){var t;clearTimeout(o),null==(t=n)||t.disconnect(),n=null}return!function l(c,h){void 0===c&&(c=!1),void 0===h&&(h=1),a();let d=t.getBoundingClientRect(),{left:p,top:u,width:g,height:f}=d;if(c||e(),!g||!f)return;let m=ig(u),v=ig(r.clientWidth-(p+g)),b={rootMargin:-m+"px "+-v+"px "+-ig(r.clientHeight-(u+f))+"px "+-ig(p)+"px",threshold:ip(0,id(1,h))||1},w=!0;function _(e){let n=e[0].intersectionRatio;if(n!==h){if(!w)return l();n?l(!1,n):o=setTimeout(()=>{l(!1,1e-7)},1e3)}1!==n||oe(d,t.getBoundingClientRect())||l(),w=!1}try{n=new IntersectionObserver(_,{...b,root:r.ownerDocument})}catch{n=new IntersectionObserver(_,b)}n.observe(t)}(!0),a}(p,o):null,f=-1,m=null;c&&(m=new ResizeObserver(t=>{let[n]=t;n&&n.target===p&&m&&(m.unobserve(e),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var t;null==(t=m)||t.observe(e)})),o()}),p&&!d&&m.observe(p),m.observe(e));let v=d?i0(t):null;return d&&function e(){let n=i0(t);v&&!oe(v,n)&&o(),v=n,r=requestAnimationFrame(e)}(),o(),()=>{var t;u.forEach(t=>{a&&t.removeEventListener("scroll",o),l&&t.removeEventListener("resize",o)}),null==g||g(),null==(t=m)||t.disconnect(),m=null,d&&cancelAnimationFrame(r)}}(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){var t,e,o;if(!this.active||!this.anchorEl)return;let n=[{name:"offset",options:t={mainAxis:this.distance,crossAxis:this.skidding},async fn(e){var o,n;let{x:r,y:a,placement:l,middlewareData:c}=e,h=await iT(e,t);return l===(null==(o=c.offset)?void 0:o.placement)&&null!=(n=c.arrow)&&n.alignmentOffset?{}:{x:r+h.x,y:a+h.y,data:{...h,placement:l}}}}];this.sync?n.push(oi({apply:({rects:t})=>{let e="width"===this.sync||"both"===this.sync,o="height"===this.sync||"both"===this.sync;this.popup.style.width=e?`${t.reference.width}px`:"",this.popup.style.height=o?`${t.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&n.push({name:"flip",options:e={boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding},async fn(t){var o,n,r,a,l,c;let{placement:h,middlewareData:d,rects:p,initialPlacement:u,platform:g,elements:f}=t,{mainAxis:m=!0,crossAxis:v=!0,fallbackPlacements:b,fallbackStrategy:w="bestFit",fallbackAxisSideDirection:_="none",flipAlignment:C=!0,...$}=iy(e,t);if(null!=(o=d.arrow)&&o.alignmentOffset)return{};let x=iw(h),S=ix(u),A=iw(u)===u,P=await (null==g.isRTL?void 0:g.isRTL(f.floating)),E=b||(A||!C?[iS(u)]:function(t){let e=iS(t);return[ik(t),e,ik(e)]}(u)),T="none"!==_;!b&&T&&E.push(...function(t,e,o,n){let r=i_(t),a=function(t,e,o){let n=["left","right"],r=["right","left"];switch(t){case"top":case"bottom":if(o)return e?r:n;return e?n:r;case"left":case"right":return e?["top","bottom"]:["bottom","top"];default:return[]}}(iw(t),"start"===o,n);return r&&(a=a.map(t=>t+"-"+r),e&&(a=a.concat(a.map(ik)))),a}(u,C,_,P));let D=[u,...E],O=await iM(t,$),B=[],F=(null==(n=d.flip)?void 0:n.overflows)||[];if(m&&B.push(O[x]),v){let t=function(t,e,o){void 0===o&&(o=!1);let n=i_(t),r=iC(ix(t)),a=i$(r),l="x"===r?n===(o?"end":"start")?"right":"left":"start"===n?"bottom":"top";return e.reference[a]>e.floating[a]&&(l=iS(l)),[l,iS(l)]}(h,p,P);B.push(O[t[0]],O[t[1]])}if(F=[...F,{placement:h,overflows:B}],!B.every(t=>t<=0)){let t=((null==(r=d.flip)?void 0:r.index)||0)+1,e=D[t];if(e){let o="alignment"===v&&S!==ix(e),n=(null==(l=F[0])?void 0:l.overflows[0])>0;if(!o||n)return{data:{index:t,overflows:F},reset:{placement:e}}}let o=null==(a=F.filter(t=>t.overflows[0]<=0).sort((t,e)=>t.overflows[1]-e.overflows[1])[0])?void 0:a.placement;if(!o)switch(w){case"bestFit":{let t=null==(c=F.filter(t=>{if(T){let e=ix(t.placement);return e===S||"y"===e}return!0}).map(t=>[t.placement,t.overflows.filter(t=>t>0).reduce((t,e)=>t+e,0)]).sort((t,e)=>t[1]-e[1])[0])?void 0:c[0];t&&(o=t);break}case"initialPlacement":o=u}if(h!==o)return{reset:{placement:o}}}return{}}}),this.shift&&n.push({name:"shift",options:o={boundary:this.shiftBoundary,padding:this.shiftPadding},async fn(t){let{x:e,y:n,placement:r}=t,{mainAxis:a=!0,crossAxis:l=!1,limiter:c={fn:t=>{let{x:e,y:o}=t;return{x:e,y:o}}},...h}=iy(o,t),d={x:e,y:n},p=await iM(t,h),u=ix(iw(r)),g=iC(u),f=d[g],m=d[u];if(a){let t="y"===g?"top":"left",e="y"===g?"bottom":"right",o=f+p[t],n=f-p[e];f=ip(o,id(f,n))}if(l){let t="y"===u?"top":"left",e="y"===u?"bottom":"right",o=m+p[t],n=m-p[e];m=ip(o,id(m,n))}let v=c.fn({...t,[g]:f,[u]:m});return{...v,data:{x:v.x-e,y:v.y-n,enabled:{[g]:a,[u]:l}}}}}),this.autoSize?n.push(oi({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:t,availableHeight:e})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${e}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${t}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&n.push(oo({element:this.arrowEl,padding:this.arrowPadding}));let r="absolute"===this.strategy?t=>ot.getOffsetParent(t,oa):ot.getOffsetParent;os(this.anchorEl,this.popup,{placement:this.placement,middleware:n,strategy:this.strategy,platform:io(ii({},ot),{getOffsetParent:r})}).then(({x:t,y:e,middlewareData:o,placement:n})=>{let r="rtl"===this.localize.dir(),a={top:"bottom",right:"left",bottom:"top",left:"right"}[n.split("-")[0]];if(this.setAttribute("data-current-placement",n),Object.assign(this.popup.style,{left:`${t}px`,top:`${e}px`}),this.arrow){let t=o.arrow.x,e=o.arrow.y,n="",l="",c="",h="";if("start"===this.arrowPlacement){let o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";n="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",l=r?o:"",h=r?"":o}else if("end"===this.arrowPlacement){let o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";l=r?"":o,h=r?o:"",c="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(h="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":"",n="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":""):(h="number"==typeof t?`${t}px`:"",n="number"==typeof e?`${e}px`:"");Object.assign(this.arrowEl.style,{top:n,right:l,bottom:c,left:h,[a]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return ey`
    ...
    `}};oc.styles=[e0,eZ],is([eI(".popup")],oc.prototype,"popup",2),is([eI(".popup__arrow")],oc.prototype,"arrowEl",2),is([eD()],oc.prototype,"anchor",2),is([eD({type:Boolean,reflect:!0})],oc.prototype,"active",2),is([eD({reflect:!0})],oc.prototype,"placement",2),is([eD({reflect:!0})],oc.prototype,"strategy",2),is([eD({type:Number})],oc.prototype,"distance",2),is([eD({type:Number})],oc.prototype,"skidding",2),is([eD({type:Boolean})],oc.prototype,"arrow",2),is([eD({attribute:"arrow-placement"})],oc.prototype,"arrowPlacement",2),is([eD({attribute:"arrow-padding",type:Number})],oc.prototype,"arrowPadding",2),is([eD({type:Boolean})],oc.prototype,"flip",2),is([eD({attribute:"flip-fallback-placements",converter:{fromAttribute:t=>t.split(" ").map(t=>t.trim()).filter(t=>""!==t),toAttribute:t=>t.join(" ")}})],oc.prototype,"flipFallbackPlacements",2),is([eD({attribute:"flip-fallback-strategy"})],oc.prototype,"flipFallbackStrategy",2),is([eD({type:Object})],oc.prototype,"flipBoundary",2),is([eD({attribute:"flip-padding",type:Number})],oc.prototype,"flipPadding",2),is([eD({type:Boolean})],oc.prototype,"shift",2),is([eD({type:Object})],oc.prototype,"shiftBoundary",2),is([eD({attribute:"shift-padding",type:Number})],oc.prototype,"shiftPadding",2),is([eD({attribute:"auto-size"})],oc.prototype,"autoSize",2),is([eD()],oc.prototype,"sync",2),is([eD({type:Object})],oc.prototype,"autoSizeBoundary",2),is([eD({attribute:"auto-size-padding",type:Number})],oc.prototype,"autoSizePadding",2),is([eD({attribute:"hover-bridge",type:Boolean})],oc.prototype,"hoverBridge",2),oc.define("sl-popup");var oh=Object.defineProperty,od=Object.getOwnPropertyDescriptor,op=(t,e,o,n)=>{for(var r,a=n>1?void 0:n?od(e,o):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(n?r(e,o,a):r(a))||a);return n&&a&&oh(e,o,a),a};let ou=class extends GlElement{constructor(){super(),this.placement="bottom",this.disabled=!1,this.distance=8,this.open=!1,this.arrow=!0,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleTriggerBlur=t=>{this.open&&this.hasTrigger("focus")&&(t.relatedTarget&&this.contains(t.relatedTarget)||this.hide())},this.handleTriggerClick=t=>{if(this.hasTrigger("click"))if(this.open&&"hover"!==this._triggeredBy){if(this._skipHideOnClick){this._skipHideOnClick=!1;return}if(t.composedPath().includes(this.body))return;this.hide()}else this.show("click")},this._skipHideOnClick=!1,this.handleTriggerMouseDown=()=>{this.hasTrigger("click")&&this.hasTrigger("focus")&&!this.matches(":focus-within")?this._skipHideOnClick=!0:this._skipHideOnClick=!1},this.handleTriggerFocus=()=>{this.hasTrigger("focus")&&(this.open&&"hover"!==this._triggeredBy&&!this.hasPopupFocus()?this.hide():this.show("focus"))},this.handleDocumentKeyDown=t=>{"Escape"===t.key&&(t.stopPropagation(),this.hide())},this.handlePopupBlur=t=>{let e=t.composedPath();e.includes(this)||e.includes(this.body)||this.hide()},this.handleWebviewBlur=()=>{this.hide()},this.handleWebviewMouseDown=t=>{let e=t.composedPath();e.includes(this)||e.includes(this.body)||this.hide()},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let t=tw(getComputedStyle(this).getPropertyValue("--show-delay"));this.hoverTimeout=setTimeout(()=>this.show("hover"),t)}},this.handleMouseOut=t=>{if(this.hasTrigger("hover")){clearTimeout(this.hoverTimeout);let e=t.composedPath();if(e[e.length-2]===this||this.hasPopupFocus()||"hover"!==this._triggeredBy)return;let o=tw(getComputedStyle(this).getPropertyValue("--hide-delay"));this.hoverTimeout=setTimeout(()=>this.hide(),o)}},this.addEventListener("blur",this.handleTriggerBlur,!0),this.addEventListener("focus",this.handleTriggerFocus,!0),this.addEventListener("click",this.handleTriggerClick),this.addEventListener("mousedown",this.handleTriggerMouseDown),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}static closeOthers(t){for(let e of ou.openPopovers)e===t||e.compareDocumentPosition(t)&Node.DOCUMENT_POSITION_CONTAINS||e.hide()}get currentPlacement(){return this.popup?.getAttribute("data-current-placement")??this.placement}disconnectedCallback(){this.closeWatcher?.destroy(),document.removeEventListener("focusin",this.handlePopupBlur),window.removeEventListener("webview-blur",this.handleWebviewBlur,!1),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleWebviewMouseDown),ou.openPopovers.delete(this),super.disconnectedCallback()}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}render(){return ey`<sl-popup
		...
		`],op([eI("#popover")],ou.prototype,"body",2),op([eI("sl-popup")],ou.prototype,"popup",2),op([eD({reflect:!0})],ou.prototype,"placement",2),op([eD({type:Object})],ou.prototype,"anchor",2),op([eD({reflect:!0,type:Boolean})],ou.prototype,"disabled",2),op([eD({type:Number})],ou.prototype,"distance",2),op([eD({reflect:!0,type:Boolean})],ou.prototype,"open",2),op([eD({reflect:!0,type:Boolean})],ou.prototype,"arrow",2),op([eD({type:Number})],ou.prototype,"skidding",2),op([eD()],ou.prototype,"trigger",2),op([eD({type:Boolean})],ou.prototype,"hoist",2),op([eD({reflect:!0})],ou.prototype,"appearance",2),op([eV("open",{afterFirstUpdate:!0})],ou.prototype,"handleOpenChange",1),op([eV(["distance","hoist","placement","skidding"])],ou.prototype,"handleOptionsChange",1),op([eV("disabled")],ou.prototype,"handleDisabledChange",1),ou=op([eM("gl-popover")],ou);var og=new Map,of=new WeakMap;function om(t,e){return"rtl"===e.toLowerCase()?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function ov(t,e){og.set(t,null!=e?e:{keyframes:[],options:{duration:0}})}function ob(t,e,o){let n=of.get(t);if(null==n?void 0:n[e])return om(n[e],o.dir);let r=og.get(e);return r?om(r,o.dir):{keyframes:[],options:{duration:0}}}let unsafe_html_e=class unsafe_html_e extends directive_i{constructor(t){if(super(t),this.it=e_,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===e_||null==t)return this._t=void 0,this.it=t;if(t===ew)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};unsafe_html_e.directiveName="unsafeHTML",unsafe_html_e.resultType=1;let oy=on(unsafe_html_e);var ow=tV`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;function o_(t,e){return new Promise(o=>{t.addEventListener(e,function n(r){r.target===t&&(t.removeEventListener(e,n),o())})})}function oC(t,e,o){return new Promise(n=>{if((null==o?void 0:o.duration)===1/0)throw Error("Promise-based animations must be finite.");let r=t.animate(e,io(ii({},o),{duration:window.matchMedia("(prefers-reduced-motion: reduce)").matches?0:o.duration}));r.addEventListener("cancel",n,{once:!0}),r.addEventListener("finish",n,{once:!0})})}function o$(t){return(t=t.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?1e3*parseFloat(t):parseFloat(t)}function ox(t){return Promise.all(t.getAnimations().map(t=>new Promise(e=>{t.cancel(),requestAnimationFrame(e)})))}function ok(t,e){let o=ii({waitUntilFirstUpdate:!1},e);return(e,n)=>{let{update:r}=e,a=Array.isArray(t)?t:[t];e.update=function(t){a.forEach(e=>{if(t.has(e)){let r=t.get(e),a=this[e];r!==a&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[n](r,a)}}),r.call(this,t)}}}var oS=class extends ih{constructor(){super(),this.localize=new e2(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=t=>{"Escape"===t.key&&(t.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){let t=o$(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),t)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){let t=o$(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),t)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var t;super.disconnectedCallback(),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(t){return this.trigger.split(" ").includes(t)}async handleOpenChange(){var t,e;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(t=this.closeWatcher)||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await ox(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:e,options:o}=ob(this,"tooltip.show",{dir:this.localize.dir()});await oC(this.popup.popup,e,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await ox(this.body);let{keyframes:t,options:o}=ob(this,"tooltip.hide",{dir:this.localize.dir()});await oC(this.popup.popup,t,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,o_(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,o_(this,"sl-after-hide")}render(){return ey`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};oS.styles=[e0,ow],oS.dependencies={"sl-popup":oc},is([eI("slot:not([name])")],oS.prototype,"defaultSlot",2),is([eI(".tooltip__body")],oS.prototype,"body",2),is([eI("sl-popup")],oS.prototype,"popup",2),is([eD()],oS.prototype,"content",2),is([eD()],oS.prototype,"placement",2),is([eD({type:Boolean,reflect:!0})],oS.prototype,"disabled",2),is([eD({type:Number})],oS.prototype,"distance",2),is([eD({type:Boolean,reflect:!0})],oS.prototype,"open",2),is([eD({type:Number})],oS.prototype,"skidding",2),is([eD()],oS.prototype,"trigger",2),is([eD({type:Boolean})],oS.prototype,"hoist",2),is([ok("open",{waitUntilFirstUpdate:!0})],oS.prototype,"handleOpenChange",1),is([ok(["content","distance","hoist","placement","skidding"])],oS.prototype,"handleOptionsChange",1),is([ok("disabled")],oS.prototype,"handleDisabledChange",1),ov("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),ov("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}}),oS.define("sl-tooltip");var oA=Object.defineProperty,oL=Object.getOwnPropertyDescriptor,oP=(t,e,o,n)=>{for(var r,a=n>1?void 0:n?oL(e,o):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(n?r(e,o,a):r(a))||a);return n&&a&&oA(e,o,a),a};ov("tooltip.show",null),ov("tooltip.hide",null);let oE=class extends lit_element_i{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver(t=>{for(let e of t)if("attributes"===e.type&&"data-current-placement"===e.attributeName){let t=e.target.getAttribute("data-current-placement");t?this.setAttribute("data-current-placement",t):this.removeAttribute("data-current-placement")}});let t=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;t&&this.observer.observe(t,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect(),super.disconnectedCallback()}render(){var t;return ey`<sl-tooltip
			.placement=${this.placement}
...
`)?oy(t.replace(/\n\n/g,"<hr>").replace(/\n/g,"<br>")):t}</slot>
	...
	`,oP([eD()],oE.prototype,"content",2),oP([eD({reflect:!0})],oE.prototype,"placement",2),oP([eD({type:Boolean})],oE.prototype,"disabled",2),oP([eD({type:Number})],oE.prototype,"distance",2),oP([eD({type:Boolean})],oE.prototype,"hoist",2),oE=oP([eM("gl-tooltip")],oE);let oM=t=>t??e_,{I:oT}={M:ee,P:ei,A:eo,C:1,L:ek,R:M,D:ec,V:eS,I:R,H:k,N:I,U:L,B:H,F:z},oR=t=>null===t||"object"!=typeof t&&"function"!=typeof t,oD=t=>void 0===t.strings,oO=(t,e)=>{let o=t._$AN;if(void 0===o)return!1;for(let t of o)t._$AO?.(e,!1),oO(t,e);return!0},oI=t=>{let e,o;do{if(void 0===(e=t._$AM))break;(o=e._$AN).delete(t),t=e}while(0===o?.size)},oN=t=>{for(let e;e=t._$AM;t=e){let o=e._$AN;if(void 0===o)e._$AN=o=new Set;else if(o.has(t))break;o.add(t),oz(e)}};function oH(t){void 0!==this._$AN?(oI(this),this._$AM=t,oN(this)):this._$AM=t}function oB(t,e=!1,o=0){let n=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(e)if(Array.isArray(n))for(let t=o;t<n.length;t++)oO(n[t],!1),oI(n[t]);else null!=n&&(oO(n,!1),oI(n));else oO(this,t)}let oz=t=>{2==t.type&&(t._$AP??=oB,t._$AQ??=oH)};let async_directive_f=class async_directive_f extends directive_i{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,o){super._$AT(t,e,o),oN(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(oO(this,t),oI(this))}setValue(t){if(oD(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};let private_async_helpers_s=class private_async_helpers_s{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}};let private_async_helpers_i=class private_async_helpers_i{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(t=>this.Z=t)}resume(){this.Z?.(),this.Y=this.Z=void 0}};let oF=t=>!oR(t)&&"function"==typeof t.then;let until_c=class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=0x3fffffff,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...t){return t.find(t=>!oF(t))??ew}update(t,e){let o=this._$Cbt,n=o.length;this._$Cbt=e;let r=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){let l=e[t];if(!oF(l))return this._$Cwt=t,l;t<n&&l===o[t]||(this._$Cwt=0x3fffffff,n=0,Promise.resolve(l).then(async t=>{for(;a.get();)await a.get();let e=r.deref();if(void 0!==e){let o=e._$Cbt.indexOf(l);o>-1&&o<e._$Cwt&&(e._$Cwt=o,e.setValue(t))}}))}return ew}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};let oU=on(until_c);var oq=Object.defineProperty,oj=Object.getOwnPropertyDescriptor,oV=(t,e,o,n)=>{for(var r,a=n>1?void 0:n?oj(e,o):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(n?r(e,o,a):r(a))||a);return n&&a&&oq(e,o,a),a};let oZ=class extends lit_element_i{constructor(){super(...arguments),this.type="info",this._hasPromo=!1}get hasPromo(){return this._hasPromo}set hasPromo(t){this._hasPromo=t}render(){return ey`${oU(this.promoPromise?.then(t=>this.renderPromo(t)),e_)}`}renderPromo(t){if(!t?.content?.webview){this.hasPromo=!1;return}let e=t.content.webview;switch(this.type){case"icon":return ey`<code-icon icon="star-full" size="16"></code-icon>`;case"info":if(e.info)return this.hasPromo=!0,ey`<p class="promo" part="text">${oy(e.info.html)}</p>`;break;case"link":if(e.link)return this.hasPromo=!0,ey`<a
						class="link"
						part="link"
						href="${this.getCommandUrl(t)}"
						title="${oM(e.link.title)}"
						>${oy(e.link.html)}</a
					>`}return this.hasPromo=!1,e_}getCommandUrl(t){let e;return t?.content?.webview?.link?.command?.startsWith("command:")&&(e=t.content.webview.link.command.substring(8)),v(e??"gitlens.plus.upgrade",this.source)}focus(){this._focusable?.focus()}};oZ.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},oZ.styles=[tV`
			:host {
				display: block;
			}
		...
		`],oV([eI('a,button,[tabindex="0"]')],oZ.prototype,"_focusable",2),oV([eD({type:Object})],oZ.prototype,"promoPromise",2),oV([eD({type:Object})],oZ.prototype,"source",2),oV([eD({reflect:!0,type:String})],oZ.prototype,"type",2),oV([eD({type:Boolean,reflect:!0,attribute:"has-promo"})],oZ.prototype,"hasPromo",1),oZ=oV([eM("gl-promo")],oZ);var oW=Object.defineProperty,oG=Object.getOwnPropertyDescriptor,oY=(t,e,o,n)=>{for(var r,a=n>1?void 0:n?oG(e,o):e,l=t.length-1;l>=0;l--)(r=t[l])&&(a=(n?r(e,o,a):r(a))||a);return n&&a&&oW(e,o,a),a};let oK=class extends lit_element_i{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){var t,e,o;return null==this.subscription?0:(t=this.subscription,e="days",o=t.plan.effective.expiresOn,(null!=o?function(t,e,o,n){let r=("number"==typeof e?e:e.getTime())-("number"==typeof t?t:t.getTime()),a=n??Math.floor;switch(o){case"days":return a(r/864e5);case"hours":return a(r/36e5);case"minutes":return a(r/6e4);case"seconds":return a(r/1e3);default:return r}}(Date.now(),new Date(o),e,Math.round):void 0)??0)}get state(){return this.subscription?.state}render(){return ey`
		...
		`}renderBadge(){let t=this.preview?"Preview":"Pro";if(null!=this.subscription)if(this.state===eN.VerificationRequired)return ey`${t} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;else{var e,o;if(e=this.subscription.plan.actual.id,eH.includes(e)||this.cloud&&null!=this.subscription.account)return ey`${t} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(o=this.subscription).state?o.state===eN.Trial:o.plan.actual.id!==o.plan.effective.id)return ey`${t} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}return t}renderPopoverHeader(){let t=ey`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===eN.Paid?ey`<div class="popup-header">${t}</div>`:this.cloud?this.preview?ey`<div class="popup-header">
			...
			${t}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){let t;if(null==this.subscription)return e_;switch(this.state){case eN.Paid:var e;t=ey`<p>
					Your
				...
				</p>`;break;case eN.VerificationRequired:t=ey`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							density="tight"
						...
						></gl-button>
					</div>`;break;case eN.Trial:{let e=this.daysRemaining;t=ey`<p>
						You have
						<strong>${e<1?"<1 day":te("day",e,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case eN.TrialExpired:t=ey`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(ey`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case eN.TrialReactivationEligible:t=ey`<p>
					...
					${this.renderStartTrialActions()}`}return ey`<div class="popup-content">${t}</div>`}renderStartTrialActions(){return ey`<div class="actions">
		...
		</div>`}renderUpgradeActions(t){return ey`<div class="actions">
			${t??e_}
			<gl-button
				density="tight"
		...
		`],oY([eD({type:Boolean})],oK.prototype,"cloud",2),oY([eD({reflect:!0})],oK.prototype,"placement",2),oY([eD({type:Boolean})],oK.prototype,"preview",2),oY([function({context:t,subscribe:e}){return(o,n)=>{"object"==typeof n?n.addInitializer(function(){new s(this,{context:t,callback:t=>{o.set.call(this,t)},subscribe:e})}):o.constructor.addInitializer(o=>{new s(o,{context:t,callback:t=>{o[n]=t},subscribe:e})})}}({context:"promos"})],oK.prototype,"promos",2),oY([eD({type:Object})],oK.prototype,"source",2),oY([eD({attribute:!1})],oK.prototype,"subscription",2),oK=oY([eM("gl-feature-badge")],oK);var oJ=Object.defineProperty,oQ=Object.getOwnPropertyDescriptor;let oX=class extends lit_element_i{render(){return ey`<svg
			alt="GitLens"
			width="159"
			height="46"
			viewBox="0 0 159 46"
		...
		`,n=[],r=(this.state.config.autolinks?.length||0)>0;r&&this.state.config.autolinks?.forEach((t,e)=>n.push(o(e,t))),n.push(o(this.state.config.autolinks?.length??0,void 0,!0,!r)),r&&n.push(e()),t.innerHTML=n.join("")}};function o0(t){return"true"===t||"false"!==t&&("null"===t?null:t)}function o3(t,e,o){let n=e.split("."),r=n.length,a=r-1,l=-1,c=t;for(;null!=c&&++l<r;){let t=n[l],e=o;if(l!==a){let o=c[t];e="object"==typeof o?o:{}}c[t]=e,c=c[t]}return t}function o5(t){switch(t){case"on":return!0;case"null":return null;case"undefined":return;default:return t}}new SettingsApp;export{SettingsApp};