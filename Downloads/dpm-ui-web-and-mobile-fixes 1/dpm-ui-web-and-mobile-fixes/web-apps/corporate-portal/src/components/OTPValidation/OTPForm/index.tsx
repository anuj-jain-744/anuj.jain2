...
const OTPForm: React.FC<OTPFormProps> = ({
  ...
  const enableVerifyButton = () => {
    return otpValueIn.join("").length === 4;
  };
  ...
  return (
    <React.Fragment>
      ...
      <div className="expireOTPSection">
        ...
        <div className="expireOTPInnerDiv2">
          <a
            ...
            target="#"
            onClick={() => {
              if (timeLeft === 0 && !isResendDisabled && !isInputDisabled) {
                handleResendOTP();
              }
            }}
          >
      ...
      {
        <div
          className={`form-submit-btn ${enableVerifyButton() && "form-submit-btn-active"
            }`}
        >
          <button
            className={`form-btn ${enableVerifyButton() && "form-btn-active"}`}
