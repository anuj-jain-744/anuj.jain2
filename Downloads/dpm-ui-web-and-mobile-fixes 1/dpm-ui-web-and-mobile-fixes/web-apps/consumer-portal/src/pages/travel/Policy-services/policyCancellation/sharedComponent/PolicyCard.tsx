...
import Spare from "claims/register/compensation/Spare";
    ...
    prodcutCode === HOME ? (<Card className="right-card home-container">
      ...
      <div className="content-container">
        ...
        <div className="sum-insured">
          ...
          <div className="value">{languageData?.sar} {deductibles ?? "-"}</div>
          </div>
        </div>
        <div className="address-section">
          <div className="label">{languageData?.property}</div>
          <div className="value">{address?.streetName +' '+ address?.city + ' ' + address?.country + ' ' + address?.postCode ?? "-"}</div>
        </div>
