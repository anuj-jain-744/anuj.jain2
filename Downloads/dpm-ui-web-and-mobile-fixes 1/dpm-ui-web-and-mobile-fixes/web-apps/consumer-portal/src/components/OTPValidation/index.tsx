      ...
      >
        ...
        <Modal.Body>
          <div className="contact-description">
            {myProfileData?.updateContactData?.label === myProfile.email && (
              <span className="contact-label">
                {languageData?.please_enter_the_email_verification_code}
              </span>
            )}
            {myProfileData?.updateContactData?.label === myProfile.mobile && (
              <span className="contact-label">
                {languageData?.please_enter_the_mobile_verification_code}
              </span>
            )}
              ...
              {Array.from({ length: 4 }).map((_, index) => (
                <input
                  ...
                  className={`digitInputField field ${
                    inputDisable || isInputDisabled ? "disabled" : ""
                  }`}
