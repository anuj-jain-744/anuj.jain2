...
type ButtonVariant = "dashboardSlide" | "outline" | "removeNo" | "renewOutline" | "removeYes" | "outlineVehicleDetails" | "linked" | 'register' | 'policyPrimary' | 'policyDownload' | 'trackClaim' | 'policyLink' | 'policyDetails' | 'addDriver';
