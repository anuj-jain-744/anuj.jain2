...
import DomesticLabourCard from "components/DomesticLabour";
...
function TravelSucces({ status, data, flag = false }: TravelSuccesProps) {
  const feedbackRequest = {};
  ...
  return (
    <>
      <div className="success-container-main p-0 pb-3">
        ...
        <TravelSuccessLeft status={status} data={data} flag={flag} />
