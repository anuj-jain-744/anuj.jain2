...
import { TRAVEL_PLAN_TYPE,CURRENCY,TRAVELER } from "../../../constant";
...
return result;  
    ...
    if(plan===TRAVEL_PLAN_TYPE.world_wide && TRAVEL_PLAN_TYPE.type_family===coveragetypeselected){
    ...
    else if(plan===TRAVEL_PLAN_TYPE.world_wide){
