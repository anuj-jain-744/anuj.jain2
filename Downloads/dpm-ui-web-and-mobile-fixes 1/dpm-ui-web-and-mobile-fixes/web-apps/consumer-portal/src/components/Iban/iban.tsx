...
const DocumentUploadSection = ({
  ...
  const index = title === languageData?.cheque_leaf ? 0 : title === languageData?.bank_documents ? 1 : 2;
        ...
        {uploadedFile && (
          <div className="uploaded-files">
            ...
            <div className="delete-icon">
              <span onClick={() => onRemoveFile(fileInputRef, index)}>
    ...
    if (files && files.length > 0) {
      ...
      reader.onloadend = () => {
        ...
        setFileData((prevFileData) => {
          ...
          newFileData[index] = { docType: "372", fileName: file.name, fileExtension: file.name.split('.').pop() ?? "", docFile: base64File };
          return newFileData;
        });
