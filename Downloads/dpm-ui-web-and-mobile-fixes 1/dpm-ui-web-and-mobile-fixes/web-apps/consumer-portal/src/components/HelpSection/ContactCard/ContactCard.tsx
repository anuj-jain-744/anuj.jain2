...
const ContactCard: React.FC<ContactCardProps> = () => {
  ...
  const headerMenuCmsDataDetails = useSelector((state: RootState) => state.headerMenuLanguage);
  const cmsArray = headerMenuCmsDataDetails?.languageData[4]?.childrens ?? [];
  ...
  const rearrangedCmsArray = getPositionHelpSection(indices, cmsArray);
