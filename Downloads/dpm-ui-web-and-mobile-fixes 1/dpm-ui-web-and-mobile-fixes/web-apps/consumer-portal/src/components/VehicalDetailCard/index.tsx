  ...
  useEffect(() => {
    if(languageData && vehicleDetails) {
      setVehicleData([{
        ...
        label: vehicleDetails?.vehicleCustomID ? languageData?.custom_card_no?.toString():  languageData?.vehicle_sequence?.toString() || "",
        value: vehicleDetails?.vehicleCustomID ?? vehicleDetails?.vehicleSequenceNo ??  "N/A",
      },{
