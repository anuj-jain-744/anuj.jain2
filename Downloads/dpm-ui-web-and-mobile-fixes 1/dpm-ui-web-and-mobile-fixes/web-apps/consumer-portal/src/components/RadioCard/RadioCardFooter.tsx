  ...
  return (
    <React.Fragment>
      ...
      <div className="d-flex align-items-center">
        <div>
          <span className="footer-denomination">{TravelData?.sar}&nbsp;</span>
          <span className="walaa-medium-500 footer-amount">{worldwideexceptCardPrice}&nbsp;</span>
        </div>
  ...
  return (
    <React.Fragment>
      ...
      <div className="d-flex align-items-center">
        <div>
          <span className="footer-denomination">{TravelData?.sar}&nbsp;</span>
          <span className="walaa-medium-500 footer-amount">{worldwideCardPrice}&nbsp;</span>
        </div>
  ...
  return (
    <React.Fragment>
      ...
      <div className="d-flex align-items-center">
        <div>
          <span className="footer-denomination">{TravelData?.sar}&nbsp;</span>
          <span className="walaa-medium-500 footer-amount">{EuropeCardPrice}&nbsp;</span>
        </div>
        <div className="walaa-regular-400 footer-vat">+ {compensationTypeCardFinalVAT(
