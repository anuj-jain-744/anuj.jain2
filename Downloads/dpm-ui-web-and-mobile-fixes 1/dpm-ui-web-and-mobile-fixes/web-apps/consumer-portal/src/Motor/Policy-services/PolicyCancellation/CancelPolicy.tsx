...
import Nissan from "assets/CancelPolicy/Nissan.svg";
...
function CancelPolicy({ policyDataObj, navigateTo }: Readonly<CancelPolicyProps>) {
  ...
  const vehicle = {
    name: data?.policyLob[0]?.policyRisk[0]?.vehicleMakeText,
                                  ...
                                  {iban.length > 2 &&
                                    ...
                                    iban.length !== 24 && (
                                      <div className="error-msg">
                                        {languageData?.enter_valid_iban_no || "Enter Valid IBAN no."}
                                      </div>
                                    )}
                                  {iban.length > 2 &&
                                    !iban?.startsWith(SA) &&
                                    isValidIban === false && (
                                      <div className="error-msg">
                                        {languageData?.iban_invalid_non_sa || "IBAN not valid for non-SA accounts"}
                                      </div>
                                    )}
                                </div>
                              </div>
                    ...
                    <Accordion.Item eventKey="0" className="item-card">
                      <Accordion.Header>
                        <div className="car-parent">
                          ...
                          <div className="car">
                            <div className="car-model walaa-regular-400">
                              {vehicle.name}
                            </div>
