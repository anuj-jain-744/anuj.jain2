...
describe('PolicyDetails Component', () => {
  ...
  test('renders PolicyDetails with correct data', () => {
    ...
    // Check if the coverage plan is rendered correctly
    expect(screen.getByText(/Coverage Plan/i)).toBeInTheDocument();
    expect(screen.getByText(mockPolicyData.coverageName)).toBeInTheDocument();
