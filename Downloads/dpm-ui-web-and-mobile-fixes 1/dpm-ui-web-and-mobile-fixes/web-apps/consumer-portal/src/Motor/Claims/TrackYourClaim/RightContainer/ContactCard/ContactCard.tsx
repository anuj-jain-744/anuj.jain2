...
const ContactCard: React.FC<ContactCardProps> = () => {
  ...
  const { trackClaimInfo , contactData, handleNavigate} = useClaimContext();
   ...
   const contactUsMenu = contactData?.find((menu: Menu) => menu.linkName === "Contact Us") as Menu;
      ...
      <div className="shuffle-option-wrapper walaa-regular-400">
        ...
        {contactUsMenu.childrens.map((child, index) => {
          ...
          return (
            ...
            <div key={index} data-testid="contact-menu-items" className="shuffle-card-content-item" onClick={() => handleNavigate(child.menuUrl || "#")}>
