...
describe("UploadDocs Component", () => {
  it("should render the component correctly", () => {
    ...
    expect(screen.getByText(mockLanguageData.upload_the_supporting_docs)).toBeInTheDocument();
    expect(screen.getByText(mockLanguageData.moroor_report)).toBeInTheDocument();
    expect(screen.getByText(mockLanguageData.quotation)).toBeInTheDocument();
  });
