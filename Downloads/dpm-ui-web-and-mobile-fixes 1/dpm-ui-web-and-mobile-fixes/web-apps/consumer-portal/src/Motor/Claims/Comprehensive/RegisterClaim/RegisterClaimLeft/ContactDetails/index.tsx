...
import { SA, IBAN, comprehensiveTP, comprehensiveOD } from "../../../../../../constant";
    ...
    if (name === "IBan" || name === "mobilenum" || name === "emailId") {
      if (name === "IBan") {
        ...
        if (
          ...
          setCompensateError({
            ...compensateError,
            mobilenum: "Invalid Mobile Number",
          });
...
const handleBankNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="px-4 mx-2" data-testid="registerclaimcontact-test">
            ...
            <div className="row d-flex flex-column">
              ...
              <div className="col">
                <ThemeTextbox
                  ...
                  type="tel"
                  maxLengthIs={10}
                  value={type === comprehensiveTP ? mobilenumData : null}
            ...
            <div className="row d-flex flex-column">
              ...
              <div className="col">
                <ThemeTextbox
                  ...
                  type="text"
                  // value={validationData?.email ? validationData?.email : ""}
                  onChangehandler={updatedValue}
      ...
      {isValidIban && type !== comprehensiveOD && (<Iban fileData={fileData} setFileData={setFileData} languageData={languageData || {}} onChequeLeafUpload={() => setChequeLeafUploaded(true)}
