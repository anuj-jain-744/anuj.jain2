...
export const UploadDoc: React.FC<Props> = ({ upLoadLabels, attachedFiles, attachmentData, name, onChangehandler, errorMessage }) => {
          ...
          <div className="flex flex-col">
            ...
            <div className="attechment">
              <div className="flex flex-col">
                ...
                <DragNdrop attachedFiles={attachedFiles} name={name} upLoadLabels={upLoadLabels} attachmentData={attachmentData} onChangehandler={onChangehandler} />
                <span className="info_row"><img src={InfoImg}/>  <p className="walaa-regular-400 upldmsg">
