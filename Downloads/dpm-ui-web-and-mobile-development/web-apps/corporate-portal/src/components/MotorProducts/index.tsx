        ...
        <Container id="productToggle-1" fluid className="py-3 insurance-container">
          <div className="outer-div">
            <animated.div style={isVisible ? headerSprings : {}}>
              {data.title && <h1 className="heading-text walaa-medium-500">{data.title}</h1>}
              {data.description && (
                <p
                  className="desc-text"
                    ...
                    >
                      ...
                      {product_name === productIDs.motor && (
                        <img
                          ...
                          onClick={() => openModal(headerItem.title, headerItem.tooltip)}
                        />
                      )}
                    </Col>
                  ))}
            ...
            {data.prodmatrix.length > 0 && (
              <Row className="sub-header-row">
                ...
                {colSizes[2] && (
                  <Col md={colSizes[2]} className="sub-header walaa-medium-500 bg-col2">
                    <div className="d-flex">
                      {data.prodmatrix[0].thirdparty.map((compItem, compIndex) => (
                        <Col key={compIndex}>
                          <span className="span-align">{compItem}</span>
                        </Col>
                      ))}
