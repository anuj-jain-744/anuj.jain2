  ...
  return (
    <div id="productToggle-0" className="overview_section">
      <Container fluid id="overview-content">
        <Row>
          <AnimatedCol
            className="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-xs-12 col heading-section"
            dangerouslySetInnerHTML={{ __html: sanitizeHtml(overviewCont) }}
            style={isVisible ? springs: {}}
          />
          <AnimatedCol className="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-xs-12 blue-container"
          style={isVisible ? springs: {}}
          >
