...
import CancelPolicyContainer from "@consumer-portal/Motor/Policy-services/PoliciesCancellation/CancelPolicyContainer";
...
const location = useLocation()
  const items = [
    ...
    { label: "Cancel Policy", route: "/Motor/Claim/Policy-Cancellation" },
  ];
