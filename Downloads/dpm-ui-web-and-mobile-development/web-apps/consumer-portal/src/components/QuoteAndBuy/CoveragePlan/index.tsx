...
const TravelCoveragePlan: React.FC<TravelCoveragePlanProps> = ({
  ...
  const { travelcoverageTypeCode, travelcoveragePlan, setTravelCoveragePlan, travellerType, setTravelCoverage, travelcoverage, travelStartDate, ownerDetailsResponseData, setTravelCoverageType, dataCoverageplanselfworldwide, dataCoverageplanselfworldwideusa, dataCoverageplanselfeurope, dataCoverageplanfamilyworldwide, dataCoverageplanfamilyworldwideusa, dataCoverageplanfamilyeurope, setTravelCoverageTypeCode
  ...
  useEffect(() => {
    if (masterCoverageData) {
      ...
      if (travellerTypeCode === "2" && proposerAge && proposerAge > 80) {
