...
type ButtonVariant = "dashboardSlide" | "outline" | "removeNo" | "renewOutline" | "removeYes" | "outlineVehicleDetails" | "linked" | 'register' | 'policyPrimary' | 'policyDownload' | 'trackClaim' | 'policyLink' | 'policyDetails' | 'addDriver' | 'addEmail' | 'filterBtnsActive' | 'filterBtnsInactive' | 'filterBtnsDisabled' | 'policyDetails' | 'policyDownload' | 'policyLink' | 'policyPrimary' | 'register-call2action' | 'addEmail' | 'trackClaim' | 'addDriver' | 'removeNo' | 'removeYes' | 'outlineVehicleDetails' | 'renewOutline' | 'dashboardSlide' | 'linked' | 'filterBtnsActive' | 'filterBtnsInactive' | 'filterBtnsDisabled';
