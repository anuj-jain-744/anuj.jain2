...
import { INTERNAL_SERVER_ERROR, SOMETHING_WENT_WRONG, TRAVEL_POLICY_TYPE, HOME, coverageTypeIdMap } from "constant";
...
function TravelSuccessLeft({ status, data, flag = false, cancelPolicyData }: TravelSuccessLeftProps) {
  ...
  const allDocUrl = `/Dashboard/V1/Download/Policy/Endorsement?endorsementNo=${cancelPolicyData?.endoNo}&policyNo=${cancelPolicyData?.policyNo}`
  const {
