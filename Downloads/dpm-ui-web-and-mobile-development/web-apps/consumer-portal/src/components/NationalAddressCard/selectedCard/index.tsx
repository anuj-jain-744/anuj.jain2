        ...
        <>
          <div className="about-property-wrapper d-flex">
            <div className="form-item d-flex width-35">
              <span
                className={`d-flex align-items-center form-label ${floor_form.required && "required"
                  }`}
              >
                {floor_form?.label}
                <Modal
                ...
                >
                  <Modal.Header closeButton>{totalfloor_tooltip_title}</Modal.Header>
                  <div className='floors-container'>
                    {totalfloor_tooltip_description}
                  </div>
                </Modal>
                <button data-testid="buttonTestId" onClick={handleRefNoShow}><InfoOutlinedIcon /></button>
              </span>
              <DropdownElement
            ...
            <div className="form-item d-flex width-35">
              ...
              <Form.Control
                ...
                className={`w-100 property-year-input ${buildYearError ? "error" : ""
                  }`}
