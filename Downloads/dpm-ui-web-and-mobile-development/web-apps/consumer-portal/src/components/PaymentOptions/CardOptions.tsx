...
import { checkIsValidMonthAndYear, generateSecureHash, getMethodType, paymentSubmit } from "utils/paymentUtils";
...
export default function CardOptions({
  ...
  const paymentHandleCall = () => {
    ...
    const paymentParameters: DirectPaymentPayload = {
      Amount: Math.round(quoteData?.premiumDue) * paymentDirect + "",
  ...
  return (
    <div className="card-options">
      ...
      <div className="card-no-input">
        <ThemeButton
          title={paymentData.field_button_title + " " + getAmountText(quoteData?.premiumDue)}
          variant={
