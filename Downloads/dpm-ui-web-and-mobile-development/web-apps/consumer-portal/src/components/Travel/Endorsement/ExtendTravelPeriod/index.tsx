...
import "./index.scss"
import TermsAndConditionDialog from 'components/Travel/Claims/Comprehensive/RegisterClaim/RegisterClaimLeft/CompreTermsAndConditions/TermsAndConditionDialog';
