...
describe('CardDetails', () => {
  ...
  it('handles driver relation change', () => {
    render(<CardDetails {...mockProps} />);
    const select = screen.getByTestId('select-Driver Relation');
    fireEvent.change(select, { target: { value: 'Spouse' } });
    expect(mockProps.onDriverRelationChange).toHaveBeenCalledWith('Spouse');
  });
