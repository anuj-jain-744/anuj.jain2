...
import { DriverDetails, DriverDetailsResponseData, OwnerDetailsResponseData, PolicyDetails, TravelModel, VehicleDetails, VehicleDetailsResponseData, PremiumBreakdown, RenewPolicyDataProps } from "types/quoteAndBuy";
...
export interface QuoteAndBuyContextProps {
  ...
  selectedBenefits: { title: string; price: number; code: string; id: number }[];
  setSelectedBenefits: React.Dispatch<React.SetStateAction<{ title: string; price: number; code: string; id: number }[]>>;
...
export const QuoteAndBuyProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const [travellerType, setTravellerType] = useState<string>("2");
