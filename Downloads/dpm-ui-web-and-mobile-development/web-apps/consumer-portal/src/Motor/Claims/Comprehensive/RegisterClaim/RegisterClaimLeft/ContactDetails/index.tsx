...
import { SA, IBAN, comprehensiveTP, comprehensiveOD, OTHERS_CASE_SOURCE_TYPE, NOT_VALID_MOBILE } from "../../../../../../constant";
  ...
  return (
    <div className="px-4 mx-2" data-testid="registerclaimcontact-test">
      <Card className="right-card-register">
        ...
        {((type !== comprehensiveOD)  || (isOthersCase === OTHERS_CASE_SOURCE_TYPE))&& (
          <React.Fragment>
          ...
          <div className="d-flex flex-column">
            ...
            <div className="register-contact-estimate-value walaa-medium-500">
              <ThemeTextarea
                ...
                onChangehandler={(event)=> changeHandler(languageData?.additional_remarks ,true, event.target.value)}
              />
            </div>
          </div>
        </div>
