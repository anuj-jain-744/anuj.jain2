...
function CancelPolicy({
  ...
  const handleSuccessValidation = async () => {
    ...
    if (isTCAccepted) {
      ...
      setCancelPolicyData(policySubmit?.model)
    }
  };
  ...
  }, [refundValue,selectedPolicyNumber]);
  ...
  return (
    <>
      ...
      {isCancelPolicySuccess && (
        <PHQuoteBuyProvider>
          <QuoteAndBuyProvider>
            <TravelSucces status={false} data={travelData} flag={false} cancelPolicyData={cancelPolicyData} />
          </QuoteAndBuyProvider>
        </PHQuoteBuyProvider>
      )}
