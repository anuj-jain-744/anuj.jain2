                    ...
                    <div className='contact-details-content'>
                        <div className='contact-content'>
                            <div className='contact-mobile'>
                                ...
                                <div data-testid="edit-mobileid" className='mobile-edit' onClick={handleModal(myProfile.mobile)}>
                            ...
                            <div className='contact-email'>
                                ...
                                <div data-testid="edit-emailid" className='email-edit' onClick={handleModal(myProfile.email)}>
                    ...
                    <div className='contact-details-content'>
                        <div className='contact-content'>
                            <div className='contact-bank'>
                                ...
                                <div data-testid="edit-bankid" className='bank-edit' onClick={handleModal('bank')}>
