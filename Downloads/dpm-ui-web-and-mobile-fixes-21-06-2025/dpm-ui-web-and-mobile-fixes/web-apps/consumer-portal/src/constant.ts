...
export const docType = {
  Policy: {
    Policy_Schedule: "2",
    Policy_Confirmation_Letter: "8",
    Policy_Wording: "309", // as Dikesh suggested don't included in the API
    // Memorandum: "141", // as Dikesh suggested don't included in the API
    E_Invoice: "356",
  },
  Endorsement: {
    Endorsement_Letter: "3",
    Risk_Object_Certificates: "7",
    Policy_Wording: "309",
    Endorsement_Schedule_Letter: "500",
    E_Invoice: "356",
    Policy_Confirmation_Letter: "8",
  },
  Quotation: {
    Quotation_Letter: "1",
    Policy_Schedule_Draft: "2",
    Risk_Object_Certificates_Draft: "7",
    Premium_Debit_Note_Draft: "8",
  },
  ClaimSettlement: {
    Bank_Transfer_Slip: "301",
    Credit_Debit_Note: "101",
    Claim_Approval_Form: "308",
    Discharge_Slip_With_Subro_Wording: "305",
    Discharge_Slip_Without_Subro_Wording: "306",
    Transfer_Request: "303",
  },
  ClaimRegistration: {
    Claim_Rejection_Letter: "164",
    Claim_Acknowledgment_Slip: "159",
    Motor_Claim_Receipt_Letter: "145",
    Motor_Theft_Letter: "503",
  },
  ClaimFieldInvestigation: {
    Motor_Claim_Direction_Letter: "507",
    Motor_Claim_Repair_Approval: "504",
    Motor_Claim_Repair_Authorization: "505",
  },
  ClaimTotalloss: {
    Motor_Claim_Total_Loss_Offer: "169",
  },
  ClaimTowing: {
    Motor_Claim_Towing_Letter: "171",
  },
};

export const accessPolicyDocumentTable = {
  Policy: ['Policy Schedule', 'Policy Confirmation Letter', 'Policy Wording', 'E-Invoice'],
