...
export interface ViewPolicy {
  ...
  policyCustomer: [{ mobile?: string; email?:string; insurerNameArabic?: string; insurerName?:string; dateOfBirth?: string; dateOfBirthH?: string; nationalId: string; customerNameArabic: string, customerNameEnglish: string, primaryAddress: {} }],
