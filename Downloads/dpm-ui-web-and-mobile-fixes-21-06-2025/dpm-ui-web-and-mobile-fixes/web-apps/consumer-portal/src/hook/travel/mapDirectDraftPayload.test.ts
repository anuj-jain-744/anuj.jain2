...
describe('mapDirectDraftPayload', () => {
    it('should map the payload correctly', () => {
        ...
        const expectedPayload = {
            policyEffectiveDate: formatDate(new Date(travelDateRange[0].format())),
            travelDuration: "30",
            familyIndividual: 2,
            typeOfCoverage: "1",
            plan: "1",
        ...
        const result = mapDirectDraftPayload(travelDateRange, travellerType, ownerdetails);
