...
const RepairOption = ({
  ...
  return (
    <div
      className={`repair-option-container ${totalOptions <= 2 ? `twooptions ${coverageType} ` : ''}option-${index + 1}`}
      ...
      <div className="inner-one">
        ...
        <div>
          <div className="repair walaa-medium-500">
            <div>{name}</div>
            <div><button onClick={handleTooltipClick}><InfoOutlinedIcon /></button></div>
          </div>
