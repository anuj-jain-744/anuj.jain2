                ...
                <div>
                  ...
                  <span className="walaa-regular-400 px-3">
                    <span className="walaa-semibold-600">
                      {getCurrencySymbol(`${languageData?.sar} + ${getAmountText(autoSuggestFinalVal(comprehensiveCardPrice as number, comp3rdParty?.pricingOptions[0]?.finalAmount as number))}`)}
                    </span>
                  </span>
                </div>
              </div>
