          ...
          <div className={style.cardFrameContainer}>
            <div className={style.vehicleHeading}>
              <div className={style.logIcon}>
                <img className={style.vehicleIcon} src={getModelIcon(vehicleDetailsResponseData?.vehicleMakeTextEn, vehicleDetailsResponseData?.vehicleMakeId,  makeModelResponse || [])} alt="car icon" />
              </div>
