        ...
        <div className="header">
          ...
          <div className="footer">
            ...
            <div className="footer-images">
              <div className="imgs">
                <div>
                  <img src={GooglePlayImage} className="google-play-imgs" alt="Google Play" />
                </div>
                <div>
                  <img src={AppStoreImage} className="google-play-imgs" alt="App Store" />
                </div>
                <div>
                  <img src={AppGalleryImage} className="google-play-imgs" alt="App Gallery" />
                </div>
              </div>
            </div>
          </div>
