...
import { MOTOR, TRAVEL, HOME, MOTOR_COMP, NA, TRAVEL_TYPE, OWNER_OR_TENANT, TRAVEL_POLICY_TYPE, Home_POLICY_TYPE, commonKeywords } from "constant";
                ...
                <DetailField
                  ...
                  value={
                    policyPremiumAndBenefits
                      ? policyPremiumAndBenefits?.premiumAmount
                      : NOT_APPLICABLE
                  }
                  isAmount={true}
                />
...
interface DetailFieldProps {
  ...
  isAmount?: boolean | undefined | null;
}
