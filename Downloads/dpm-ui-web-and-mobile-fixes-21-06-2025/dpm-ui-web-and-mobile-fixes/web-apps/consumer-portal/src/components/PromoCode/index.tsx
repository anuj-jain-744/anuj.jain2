...
export function Promocode({
  ...
  useEffect(() => {
    ...
    if (isHome && premium.isError) {
      setPromoCodeError(!isPromoEmailActive ? languageData?.internal_server_error: "");
      setEmailError(isPromoEmailActive ? languageData?.internal_server_error : "");
    }
  ...
  }, [data, errors, isPromoEmailActive, isApiCall]);
