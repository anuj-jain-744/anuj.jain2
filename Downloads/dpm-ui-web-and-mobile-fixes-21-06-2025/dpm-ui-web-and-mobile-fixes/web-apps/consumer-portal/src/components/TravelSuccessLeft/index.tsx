...
import { callAPI, getFullUrl, useApiCall, sanitizeHtml, RootState } from "@dpm/shared-module";
...
function TravelSuccessLeft({ status, data, flag = false, cancelPolicyData }: TravelSuccessLeftProps) {
  ...
  usePolicyDocuments({ policyNo: refundPolicy?.policyNo, docType: docType.Policy.Policy_Schedule });
  ...
  const SuccessPolicyCancellationCard = (<Card className="policy-cancel-card">
    <div className="header">
      <div className="logo">
        ...
        <div>
          ...
          <div className="policy-cancel-number walaa-medium-500">{refundPolicy?.policyNo? refundPolicy?.policyNo.toLocaleUpperCase():''}</div>
        </div>
      </div>
    ...
    <div className="body-content">
      ...
      <div className="bottom-links">
        <div className="link-container" onClick={handleDownloadPolicy}>
          <div>
            <img src={Download} alt="Download"/>
          </div>
          <div className="links-content walaa-regular-400 btn-links">
            {data?.download_document}
          </div>
        </div>
        <div className="link-container" onClick={handleDownloadRefundReceipt}>
          <div>
            <img src={Download} alt="Download"/>
          </div>
          <div className="links-content walaa-regular-400 btn-links">
            {data?.download_refund_payment_receipt}
          </div>
        </div>
      </div>
    </div>
