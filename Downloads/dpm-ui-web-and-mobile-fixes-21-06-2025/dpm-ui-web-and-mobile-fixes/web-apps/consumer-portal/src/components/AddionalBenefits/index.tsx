                  ...
                  <div className="available-benefits ">
                    ...
                    {availableBenefits?.map((benefit, idx) => {
                      if (Number(benefit.benefitPrice) > 0) {
                        return <div key={idx} className="aditional-row">
                          <div className="benef-img">
                          ...
                          <div className="bene-rght">
                            ...
                            <div className="butn-div">
                              <button
                                ...
                                onClick={() =>
                                  toggleBenefit(benefit.benefitNameEn, benefit?.benefitNameAr, benefit.benefitPrice, benefit.benefitCode, benefit.benefitId)
                                }
                              >
