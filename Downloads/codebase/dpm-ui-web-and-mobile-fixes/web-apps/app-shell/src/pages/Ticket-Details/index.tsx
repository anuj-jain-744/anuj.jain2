...
import MyTicketDetails from '@consumer-portal/components/MyTickets/TicketDetails/TicketDetails';
...
const TicketDetailsLayout: React.FC<WalaScreenType> = ({
  bannerTitle,
  breadcrumbsData,
  handleNavigate,
  seoTags,
  ...
  const fetchData = async (
    ...
    try {
      ...
      const result = getResponseBasedOnEndpoints(responseData,endpoint)|| responseData||{}
      setter(result);
    } catch (ex) {
      console.error(ex);
    }
      ...
      {!loading && (
        <React.Fragment>
          ...
          <HighlighterBanner
            ...
            navigateTo={handleNavigate}
          />
          <MyTicketDetails sitedata={siteData}/>
        </React.Fragment>
      )}
    </React.Fragment>
  );
