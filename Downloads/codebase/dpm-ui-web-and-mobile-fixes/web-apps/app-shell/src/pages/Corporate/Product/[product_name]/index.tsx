...
const CorporateProductLanding: React.FC = () => {
  ...
  const fetchAllData = useCallback(async () => {
    const [
      ...
      fetchData(
        `${cmsAPIRoute["corporateProduct"]}${product_name}`,
        currentLanguage
      ),
    ...
    const isError = typeof productData === commonTexts.string || productData === null;
    ...
    <PublicLayout>
      <React.Fragment>
        ...
        {!loading && (
          <React.Fragment>
            {seoTags}
            <Template templateType="corporateProduct" data={combinedData} />
          </React.Fragment>
        )}
      </React.Fragment>
    </PublicLayout>
...
export default CorporateProductLanding;
