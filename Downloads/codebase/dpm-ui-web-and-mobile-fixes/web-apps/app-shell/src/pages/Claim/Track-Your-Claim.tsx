...
import { LoaderOverlay } from "../../../src/components";
...
import { getFullUrl, navigateTo,getResponseBasedOnEndpoints } from "../../../src/utils";
...
const TrackClaims: React.FC = () => {
  ...
  const items = [
    { label: "Home", route: "/" },
    { label: "Claims", route: `/track-claim` },
    { label: "Track Your Claim", route: "/track-claim" },
