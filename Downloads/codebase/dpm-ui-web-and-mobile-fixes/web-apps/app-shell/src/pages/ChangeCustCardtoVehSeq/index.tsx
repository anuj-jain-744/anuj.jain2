...
import { navigateTo ,getResponseBasedOnEndpoints} from "../../utils";
...
const ChangeCustCardtoVehSeq: React.FC = () => {
  ...
  const items = [
    ...
    { label: "Change from Custom Card No. to Vehicle Sequence No.", route: "/ChangeCustCardtoVehSeq" },
  ];
  ...
  const fetchData = async (endpoint: string) => {
    try {
      ...
      return getResponseBasedOnEndpoints(responseData,endpoint) ||
             responseData||{};
    } catch (ex) {
      console.error(ex);
      return {};
