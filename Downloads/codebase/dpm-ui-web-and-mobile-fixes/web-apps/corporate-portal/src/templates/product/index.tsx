...
export const ProductsTemplate = ({
  ...
  return (
    <div className="template-wrapper personl">
      ...
      {quote_form?.disclaimer_text && (
        ...
        <SubNavBar content={tabs} hasGetQuoteWidget={true} />
        ...
        <VisibilityWrapper isParallex={enableParallax}>
          <KeyFeature
           title={key_features_title}
            ...
            typeClass={commonKeywords.personProd}
          />
        </VisibilityWrapper>
      )}
    ...
    {productData?.data?.comprehensive?.title !== null && (
      <VisibilityWrapper isParallex={enableParallax}>
        <CoverageWidget content={getDefault(comprehensive)} 
        typeClass={productData?.data?.discounts?.discounts_title === null ? "travelCoverageWidget" : "" }
        />
      </VisibilityWrapper>
    )}

    {productData?.data?.discounts?.discounts_title !== null&& (
      <VisibilityWrapper isParallex={enableParallax}>
        <LoyaltyCard
      ...
      {(title !== commonKeywords.visitorVisa && title !== commonKeywords.arabicVisitorVisa &&
        title !== commonKeywords.domesticWorkers && title !== commonKeywords.arabicDomesticWorkers)
