...
export const Acadamy: React.FC<AcadamyProps> = ({
  ...
  const isMobileDeviceRef = useRef<boolean>(
    window.innerWidth <= commonKeywords.mobileDeviceBreakpoint
  );
    ...
    <div className="Acadamy_section">
      <Container fluid className="mid-container ">
        ...
        <Row className="two-column-section">
          <Col
            className="col-xl-8 col-lg-7 col-md-7 col-sm-12 col heading-section"
          ...
          <Col className="col-xl-4 col-lg-5 col-md-5 col-sm-12 col image-section">
            <div className="image-content-wrapper">
              ...
              <div className="image-content">
                ...
                <button
                  ...
                  onClick={() => handleNavigate(sidebar_button_link ?? "#")}
                >
                  {sidebarButton}
                </button>
              </div>
      ...
      <Container fluid className="mid-container training">
        <Row className="training-sections">
          <Col className="col-xl-4 col-lg-5 col-md-5 col-sm-12 col training-about">
            <img
              ...
              alt={trainingimagealt}
              title={trainingimagealt}
            />
          </Col>
          <Col
            className="col-xl-8 col-lg-7 col-md-7 col-sm-12 col training-heading"
            dangerouslySetInnerHTML={{ __html: trainingdiscription }}
          ></Col>
        </Row>
      </Container>
    </div>
