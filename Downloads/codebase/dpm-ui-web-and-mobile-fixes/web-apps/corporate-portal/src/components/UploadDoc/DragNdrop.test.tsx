...
describe('DragNdrop Component', () => {
  ...
  test('handles file selection', async () => {
    ...
    render(<DragNdrop name="" upLoadLabels={mockuploadlabels} attachmentData={mockattachment} attachedFiles={onFilesSelected} onChangehandler={onChangehandler} setDragFiles = {setDragFiles}/>);
