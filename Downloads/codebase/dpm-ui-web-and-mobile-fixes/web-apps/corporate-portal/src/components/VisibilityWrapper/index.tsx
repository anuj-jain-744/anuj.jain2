...
export const VisibilityWrapper: FC<VisibilityWrapperProps> = ({ children, isParallex, className }) => {
  ...
  return (
    <div ref={targetRef} data-testid="visiblityWrapper" className='visiblityWrap'>
