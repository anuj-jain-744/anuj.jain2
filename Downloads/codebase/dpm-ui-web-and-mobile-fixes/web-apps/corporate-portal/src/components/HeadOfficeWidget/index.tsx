                    ...
                    <Row className="inner-content">
                        <Col xs={12} md={6} lg={4}>
                            <div className="first-block">
                                ...
                                <div data-testid="phone" className="block-content walaa-regular-400">
                                    <CallOutlinedIcon className="icon-setup" />{data?.phone}
                                </div>
                                <div className="block-title walaa-regular-400">{data?.email_label}</div>
                                <div data-testid="email" className="block-content walaa-regular-400">
                        ...
                        <Col xs={12} md={6} lg={4}>
                            <div className="secont-block">
                                ...
                                <div data-testid="working" className="block-content walaa-regular-400">
                                ...
                                <div data-testid="working-days" className="block-content walaa-regular-400">
                            ...
                            <div className="third-block">
                                ...
                                <div className="block-content walaa-medium-500">
                                    <div data-testid="address" className="block-align">
                                        ...
                                        <div className="text-content walaa-regular-400">
                                            {data?.address}
                                        </div>
                                    </div>
                                </div>
