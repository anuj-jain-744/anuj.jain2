...
export const KeyFeature = ({ cards, title,typeClass }: KeyFeatureProps): JSX.Element => {
  ...
  return (
    <Container id="productToggle-1" fluid className={`key-feature-frame ${typeClass}`}>
            ...
            .map((card, index) => (
              <div className="key-feature-icon-cards" key={index}>
                ...
                <div className="key-feature-content">
                  ...
                  />
                  <p
                    className="key-feature-contact-us-para"
            ...
            (_, index) => (
              <div
                ...
                role="button" tabIndex={0} onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                      e.preventDefault();
                      goToSlide(index * maxVisibleCards);
                  }
              }}
              />
            )
