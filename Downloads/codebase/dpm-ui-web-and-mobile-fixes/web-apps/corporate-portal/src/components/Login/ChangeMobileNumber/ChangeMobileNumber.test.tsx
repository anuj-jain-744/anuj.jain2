...
describe('ChangeMobileNumber Component', () => {
  ...
  it('enables the submit button when form is valid', () => {
    renderComponent();
    fireEvent.change(screen.getByTestId('new_mobile_no_'), { target: { value: '1234567890' } });
    expect(screen.getByTestId('submitBtn')).not.toBeDisabled();
  });



  it('calls setCurrentStepValue when back button is clicked', () => {
    renderComponent();
  ...
  it('handles invalid form submission gracefully', () => {
    renderComponent();
