...
const CustomCardRight = ({ policyDetails, languageData, plateNumber, repairType, vehicleMakeModel }: ICustomCardRight) => {
  ...
  return (
    <div className="right-card-policy">
      <PolicyCard
        ...
        vehicleMakeModel={truncateName(vehicleMakeModel, 12)}
