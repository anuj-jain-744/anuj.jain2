...
import Green from "assets/SuccessPage/SuccessIcon.svg";
import "./style.scss";
      ...
      <div className="success-container-body">
        ...
        {typeCode ? (
          <div className="content">
            {!isCancelSuccess && <div className="success-text walaa-medium-500"> {status
                  ? (flag && processData?.quotationNo) ? languageData?.success_msg_review_quotes : languageData?.success
                  : languageData?.success_msg_cancel}</div>}
            {!flag && (
