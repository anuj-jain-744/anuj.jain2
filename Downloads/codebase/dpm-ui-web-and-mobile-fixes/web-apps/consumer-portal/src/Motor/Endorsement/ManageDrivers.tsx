   ...
   const { plateNo, plateNoText1, plateNoText2, plateNoText3 } = policyData || {};
    ...
    useEffect(() => {
        if (newDriver?.driver?.driverName) {
            ...
            } else if(languageData?.driver_already_added + languageData?.add_new_driver) {
                    setApiErrorMessage({
                        title: "",
                                ...
                                <div className="driver-list-container">
                                    ...
                                    <div className="driver-sub2">
                                        ...
                                        {newDriverArray.map((driver, index) => (
                                            ...
                                            <div key={driver.driverName + index} className="driver-card new-driver">
                                                <div className="driver">
                                                    <div className="driver-img">
                                                        <img src={getGenderProfileIcon(driver?.gender)} alt="Driver Imaga" />
                                                    </div>
                                                ...
                                                <img className="endosCrossIcon" src={CancelRed} data-testid="driver-delete" onClick={() => handleDriverDelete(index)} />
                                            </div>
                                        ))}
