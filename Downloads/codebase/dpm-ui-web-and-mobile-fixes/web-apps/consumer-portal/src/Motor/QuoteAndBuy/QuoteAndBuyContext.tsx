...
import { DriverDetails, DriverDetailsResponseData, OwnerDetailsResponseData, PolicyDetails, TravelModel, VehicleDetails, VehicleDetailsResponseData, PremiumBreakdown, RenewPolicyDataProps, Benefit } from "types/quoteAndBuy";
...
export interface QuoteAndBuyContextProps {
  ...
  setSelectedBenefits: React.Dispatch<React.SetStateAction<Benefit[]>>;
  ...
  setQuoteNumber: React.Dispatch<React.SetStateAction<string | null>>;
  expiryDate: string | null;
  setExpiryDate: React.Dispatch<React.SetStateAction<string | null>>;
  referanceNumber: string | null;
  setReferanceNumber: React.Dispatch<React.SetStateAction<string | null>>;
  email: string | null;
  ...
  policyExpiryDate: Value | string | null;
  setPolicyExpiryDate: React.Dispatch<React.SetStateAction<string | null>>;
  ...
  setSelectedPeriod: React.Dispatch<React.SetStateAction<Travel.TravelPeriodOption>>;
  travelDateRange:DateObject[];
  setTravelDateRange:React.Dispatch<React.SetStateAction<DateObject[]>>;
  ...
  setSrCitizenCount: React.Dispatch<React.SetStateAction<number>>;
  ...
  setIsRenewpolicy: React.Dispatch<React.SetStateAction<boolean>>;
  isRenewPolicyData: RenewPolicyDataProps | null;
  setIsRenewPolicyData: React.Dispatch<
    React.SetStateAction<RenewPolicyDataProps | null>
  >;
  viewPolicyData: any;
  setViewPolicyData: React.Dispatch<any>;
  isTpOnly: boolean;
  setIsTpOnly: React.Dispatch<React.SetStateAction<boolean>>;
...
export const QuoteAndBuyProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const [referanceNumber, setReferanceNumber] = useState<string | null>(null);
  ...
  const [policyExpiryDate, setPolicyExpiryDate] = useState<Value | string | null>(null);
  ...
  const [isRenewpolicy, setIsRenewpolicy] = React.useState<boolean>(false);
  const [isRenewPolicyData, setIsRenewPolicyData] = useState<RenewPolicyDataProps | null>(null);
  const [viewPolicyData, setViewPolicyData] = useState<any>(null)
  const [isTpOnly,setIsTpOnly] = React.useState<boolean>(false);

  const [travelStartDate, setTravelStartDate] = useState<Value | null>(null);
  const [selectedPeriod, setSelectedPeriod] =
    useState<Travel.TravelPeriodOption>({ label: "", value: "" });
  const [travelDateRange, setTravelDateRange] = useState<DateObject[]>([]);
  const [isToggleOn, setIsToggleOn] = useState<boolean>(true);
  const [totalCount, setTotalCount] = useState<number>(0);
  const [travelData, setTravelData] = useState<Value | null>(null);
  const [travellerType, setTravellerType] = useState<string>(travelerTypeIdMap.self);
  ...
  const [travelcoverage, setTravelCoverage] = useState<string>("");
  ...
  const QuoteAndBuyContextValue = useMemo(() => ({
    ...
    referanceNumber, setReferanceNumber,
    email,
    setEmail,
    isTermCondition,
    setIsTermCondition,
    ...
    //Renew Policy
    isRenewpolicy, setIsRenewpolicy,
    isRenewPolicyData, setIsRenewPolicyData,
    viewPolicyData, setViewPolicyData,
    isTpOnly,setIsTpOnly
  }), [
    schemeCode,
    journeyData,
    setJourneyData,
    ...
    setSchemeCode,
    premium, setPremium,
    comprehensiveCardPrice, setComprehensiveCardPrice,
    sliderValueSumInsured, setSliderValueSumInsured,
    sliderValueDeductibles, setSliderValueDeductibles,
    makeModelResponse, setMakeModelResponse,
    sliderDeductibleValue, setSliderDeductibleValue,
    minDeductibleAmount, setMinDeductibleAmount,
    maxDeductibleAmount, setMaxDeductibleAmount,
    deductibleAmounts, setDeductibleAmounts,
    repairTypeSelected, setRepairTypeSelected,
    workShopInitialPrice, setWorkShopInitialPrice,
    mathInitialPrice, setMathInitialPrice,
    agencyInitialPrice, setAgencyInitialPrice,
    selectedBenefits, setSelectedBenefits,
    vehicleDetails, setVehicleDetails,
    driverDetails, setDriverDetails,
    compWorkShop, setcompWorkShop,
    compMath, setcompMath,
    compAgency, setcompAgency,
    stepValue, setStepValue,
    selectedPackage, setSelectedPackage,
    vehicaleFormResponse, setVehicleDetail,
    comp3rdParty, setcomp3rdParty,
    vehicleDetailsResponseData, setVehicleDetailsResponseData,
    driverDetailsResponseData, setDriverDetailsResponseData,
    ownerDetailsResponseData, setOwnerDetailsResponseData,
    email, setEmail,
    isTermCondition, setIsTermCondition,
    coverageType, setCoverageType,
    policyStartDate, setPolicyStartDate,
    policyExpiryDate, setPolicyExpiryDate,
    policyStartDateAPI, setPolicyStartDateAPI,

    showManageDriverModal, setShowManageDriverModal,
    //Travel
    travelStartDate, setTravelStartDate,
    ...
    travellerType, setTravellerType,
    adultCount, setAdultCount,
    childCount, setChildCount,
    srCitizenCount, setSrCitizenCount,
    travelcoverageType, setTravelCoverageType,
    travelcoveragePlan, setTravelCoveragePlan,
    travelcoverage, setTravelCoverage,
    travelcoverageTypeCode, setTravelCoverageTypeCode,
    dataWorldwidepearl, setWorldwidepearl,
    dataWorldwidetraveller, setWorldwidetraveller,
    worldwideCardPrice, setworldwideCardPrice,
    worldwidepearlInitialPrice, setworldwidepearlInitialPrice,
    worldwidetravellerInitialPrice, setworldwidetravellerInitialPrice,
    dataworldwidepearlVAT,
    dataworldwidepearladminfee,
    dataworldwidepearlnetpremium,
    dataworldwidetravellerVAT,
    ...
    dataworldwidetravellernetpremium,
    dataWorldwideexceptpearl,
    setWorldwideexceptpearl, dataWorldwideexcepttraveller,
    setWorldwideexcepttraveller, worldwideexceptCardPrice,
    setworldwideexceptCardPrice, worldwideexceptpearlInitialPrice,
    worldwideexcepttravellerInitialPrice, dataworldwideexceptpearlVAT,
    dataworldwideexceptpearladminfee,
    dataworldwideexceptpearlnetpremium,
    dataworldwideexcepttravellerVAT,
    dataworldwideexcepttravelleradminfee,
    dataworldwideexcepttravellernetpremium,dataEuropeeurope,
    setEuropeeurope,
    dataEuropeschengen,
    setEuropeschengen,
    EuropeCardPrice,
    ...
    dataEuropeschengenVAT,
    dataEuropeschengenadminfee,
    dataEuropeschengennetpremium,travelCovidcoverage,travelWintersportscoverage, isAddTravelerValidation,
    setIsAddTravelerValidation,
    ...
    wsPremiumBreakdown,
    setWsPremiumBreakdown,
    tpPremiumBreakdown, setTpPremiumBreakdown,
    agencyPremiumBreakdown,
    setAgencyPremiumBreakdown,
    mathPremiumBreakdown,
    setMathPremiumBreakdown,
    ...
    setpTravelerPassportexpiry,
    quoteDataResponse, setQuoteDataResponse,
    travelJourneyData, setTravelJourneyData,
    adultTravelerObj, setAdultTravelerObj,
    childTravelerObj, setChildTravelerObj,
    srCitizenTravelerObj, setSrCitizenTravelerObj,
    travelersList, setTravelersList,
    ...
    travelersChild, setTravelersChild,
    travelersSrcitizen, setTravelersSrcitizen,
    dataCoverageplanselfworldwide,setCoverageplanselfworldwide,dataCoverageplanselfworldwideusa,setCoverageplanselfworldwideusa,dataCoverageplanselfeurope,
    setCoverageplanselfworldwideeurope,dataCoverageplanfamilyworldwide,setCoverageplanfamilyworldwide,dataCoverageplanfamilyworldwideusa,
    setCoverageplanfamilyworldwideusa,dataCoverageplanfamilyeurope,setCoverageplanfamilyeurope,
    worldwideCoveragePrice, setworldwideCoveragePrice,
    worldwideFamilyCoveragePrice, setworldwideFamilyCoveragePrice,
    worldwideexceptCoveragePrice, setworldwideexceptCoveragePrice,europeCoveragePrice,seteuropeCoveragePrice,
    dataworldwideCoverageFamily,setdataworldwideFamily,worldwideFamilyCPPrice,
    setworldwideFamilyCPPrice,
    worldwideSelfCPPrice,setworldwideSelfCPPrice,worldwideexceptSelfCPPrice,setworldwideexceptSelfCPPrice,europeSelfCPPrice,
    seteuropeSelfCPPrice,
    deleteStatus, setDeleteStatus,
    setdataworldwidepearlVAT,
    setdataworldwidepearladminfee,
