...
import SquareLoader from "../../../assets/QuoteAndBuy/square_loader.mp4";
...
const ValidateVehicle: React.FC<VehicalDetailsProps> = ({
  ...
  const handleSubmit = () => {
    ...
    makeApiCall(data);
    driverDetailsPayload.vehicleDefinitionType = data?.sequenceNumber ? "1" : "2";
    driverDetailsPayload.vehicleId = data?.sequenceNumber ? data?.sequenceNumber : data?.customCardNumber;
      ...
      <div className="vehical-detail-content">
        ...
        {(isLoading || isDriverLoading) && (
          <div className="d-flex justify-content-center squareloaderContainer">
            <video className="squareloader" src={SquareLoader} alt="loader" autoPlay loop muted />
          </div>
        )}
        {!isLoading && !isDriverLoading && (
          <div className="vehical-content">
            ...
            {isToggleOn && (
              <div className="vehical-radio-motor walaa-regular-400 d-flex">
                <div className="mob-tab-responsive"> 
                <ThemeRadioCheckbox
            ...
            <div className="vehical-fields">
              <Row className="mob-tab-responsive">
                ...
                <Col>
                  <ThemeButton
                    ...
                    classes="validate-vehicle-btn walaa-medium-500"
                    variant="linked"
