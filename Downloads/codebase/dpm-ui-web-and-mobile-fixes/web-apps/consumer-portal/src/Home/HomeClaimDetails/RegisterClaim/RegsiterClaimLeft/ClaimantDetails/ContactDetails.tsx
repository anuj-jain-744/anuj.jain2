    ...
    if (name === "mobilenum" || name === "emailId" || name === "IBan") {
      switch (name) {
        case "mobilenum":
          ...
          if (sanitizedValue === "" || checkPhoneNumberStarts(sanitizedValue)) {
        ...
        case "emailId":
          ...
          if (isValidSubscribeEmail(value) || value === "") {
    ...
    <div className="parent-card" data-testid="registerclaimcontact-test">
      <Card className="right-card-register">
        ...
        <IbanValidation
          ...
          onChangehandler={(event: React.FormEvent<HTMLDivElement>) =>
            updatedValue(event)
          }
