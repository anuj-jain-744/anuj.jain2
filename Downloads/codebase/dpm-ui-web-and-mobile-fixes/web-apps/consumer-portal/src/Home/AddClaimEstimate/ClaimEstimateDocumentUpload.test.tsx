...
describe("ClaimEstimateDocumentUpload Component", () => {
    ...
    const baseEstimate = {
        ...
        visibleDocs: [
            { key: "policeReport", value: "Police Report", required: true },
            { key: "stolenItemList", value: "Stolen Item List", required: false },
            { key: "purchaseInvoice", value: "Purchase Invoice", required: false },
          ],
    };
    ...
    it("calls handleRemoveFile when remove icon is clicked", () => {
        const uploadedEstimate = {
            ...
            visibleDocs: [{ key: "policeReport", value: "Police Report", required: true }],
          };
