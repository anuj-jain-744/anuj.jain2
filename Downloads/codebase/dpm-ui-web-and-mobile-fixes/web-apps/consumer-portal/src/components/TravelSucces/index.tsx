...
function TravelSucces({ status, data, flag = false, cancelPolicyData, policyDetails, address}: TravelSuccesProps) {
  const feedbackRequest = {};
  ...
  return (
    <>
      <div className="success-container-main p-0 pb-3">
        ...
        <TravelSuccessLeft address={address} startDate={policyDetails?.startDate} status={status} data={data} flag={flag} cancelPolicyData={cancelPolicyData}/>
