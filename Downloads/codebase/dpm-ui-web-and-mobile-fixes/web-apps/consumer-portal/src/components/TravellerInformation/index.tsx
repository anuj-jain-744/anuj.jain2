...
import { dateFormats, travelerTypeIdMap } from "constant";
            ...
            <div className="row pt-3">
              <div className="col">
                <div className="d-flex flex-column">
                  ...
                  <div className="travel-infor-content walaa-medium-500">
                  {`${subtractDates(formatDateObjectTo(travelEndDate, dateFormats.date).toString(), formatDateObjectTo(travelStartDate,  dateFormats.date).toString()) + 1} ${languageData?.days}`}
                  </div>
                </div>
              </div>
