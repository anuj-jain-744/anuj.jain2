        ...
        <div className={style["card-policy-container"]}>
          <div className={style["logo-policy"]}>
            <div className={style["product-policy"]}>
              ...
              <div
                className={`${style["policy-number"]} ${style["walaa-medium-500"]}`}
              >
                {policy.policyNo}
              </div>
            </div>
          ...
          <div className={style["policy-period"]}>
            <div className={style["label-value"]}>
              ...
              >
                {`${
                  policy.coverageType ?? languageData?.consumer.not_applicable
                } - ${
                  policy.travellerType ?? languageData?.consumer.not_applicable
                }`}
              </div>
            </div>
          </div>
          <div className={style["policy-period"]}>
            <div className={style["label-value"]}>
              <div
                className={`${style["label"]} ${style["walaa-regular-400"]}`}
              >
