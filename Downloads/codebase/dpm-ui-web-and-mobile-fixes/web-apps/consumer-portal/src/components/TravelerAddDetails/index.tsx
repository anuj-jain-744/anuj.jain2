...
import {
  INVALID_SENIOR_CITIZEN_DELETED_MSG,
  TRAVEL_TOTAL_COUNT,
  travelerTypeIdMap,
} from "constant";
...
const TravelerAddDetails: React.FC<TravelerAddDetailsData> = ({
  data,
  setLeftStep,
}) => {
  ...
  useEffect(() => {
    ...
    const finalValidation =
      ...
      travelersChild.length === counts.child &&
      travelers.length === counts.adult &&
      travelersSrcitizen.length === counts.senior;
    ...
    <>
      <div className="traveler-winter-container">
        <Modal
          ...
          centered
          className="modal-lg winter-travel-benefit-all"
        >
          ...
          <Modal.Footer>
            ...
            <Button
              variant="primary"
              className="delete-btn btn-width"
              onClick={addBenfitToAllYes}
            >
              {`${data?.yes}`}
            </Button>
          </Modal.Footer>
      ...
      <div className="traveler-detail-wrapper">
        <div className="traveler-detail-content">
          <div className="traveler-section">
                  ...
                  <Col>
                    <SeniorCitizenAlert
                      ...
                      handleAlertDismissal={() =>
                        setShouldShowInvalidSrCitizenDeletedAlert(false)
                      }
                    />
                  </Col>
                </Row>
            ...
            {travellerType === travelerTypeIdMap.family && totalCount < TRAVEL_TOTAL_COUNT ? (
