...
function UploadDoc() {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log("outside  selectedFile", Objectfile);
    setSelected(Objectfile);
    // console.log("outside  selectedFile", Object.keys(Objectfile).length);
    for (const key in Objectfile) {
      console.log("object--<><>  ", Objectfile[key]);
    }
