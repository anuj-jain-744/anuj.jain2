...
function MoroorReport({ changeHandler }: typeCompreUploadFiles) {
  //MoroorReport
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log("selected files--<>mrreport  ", selectedFileMoroorRep);
      ...
      <div className="col">
        <div className="register-contact-estimate uploadfncontainer">
          <div className="register-row-large-spacing-top register-row-large-spacing-bottom">
            <div className="row">
              <div className="col">{language?.moroor_report}</div>
