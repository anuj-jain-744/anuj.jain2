...
import {
  processPolicies,
  getUniquePoliciesWithLatestEndorsementNumber,
} from "utils/processPolicies";
...
describe("usePolicyData", () => {
  const mockPolicies = [
    ...
    },
    {
      ...
      endorsementType: REQUEST_TYPES.CANCELLATION,
      productCode: "03",
      endorsementNo: null,
    },
    {
  ...
  beforeEach(() => {
    ...
    (
      getUniquePoliciesWithLatestEndorsementNumber as jest.Mock
    ).mockImplementation((policies) => policies);
  });
