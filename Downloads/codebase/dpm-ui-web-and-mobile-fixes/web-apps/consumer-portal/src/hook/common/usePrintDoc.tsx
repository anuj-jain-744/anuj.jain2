 ...
 */
export const useClaimDocuments = ({ transType, claimNo, subClaimNo, docType }: ClaimDocumentsParams) => {
  return useQuery<DocumentData, ApiError>({
    queryKey: ['claimDocuments', claimNo, subClaimNo, docType],
    queryFn: () => fetchClaimDocuments({ transType, claimNo, subClaimNo, docType }),
