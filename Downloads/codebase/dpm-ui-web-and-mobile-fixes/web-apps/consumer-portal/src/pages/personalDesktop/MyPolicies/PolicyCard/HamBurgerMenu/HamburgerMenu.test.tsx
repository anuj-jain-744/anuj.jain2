...
const policyDataProps = {
  additionalCode: " ",
  buildingNo: "4062",
  creatorId: "WALAA_ONLINE",
  email: " ",
  endorsementType: "ADD",
  insurerName: "Arabic Name",
  issueDate: "2025-07-03T12:25:45.000+00:00",
  mobileNo: "0506361056",
  ...
  description: "Your policy is active.",
  productName: "Travel",
  quoteNo: "Q-25-605-0011461",
...
describe('HamburgerMenu Component - Comprehensive Coverage', () => {
  ...
  test('renders HamburgerMenu with correct menu items', () => {
    render(<HamburgerMenu menuItems={menuItemsMock} toggleMenuVisibility={jest.fn()} isOpen={true} policyData={policyDataProps}/>);
  ...
  test('handles navigation for all menu items with different product codes', () => {
    ...
    const { rerender } = render(
      <HamburgerMenu
        ...
        isOpen={true}
        policyData={{ ...policyDataProps, productCode: 'MOTOR' }}
      />
    );
    ...
    rerender(
      <HamburgerMenu
        ...
        toggleMenuVisibility={jest.fn()}
        isOpen={true}
        policyData={{ ...policyDataProps, productCode: TRAVEL }}
      />
    );
