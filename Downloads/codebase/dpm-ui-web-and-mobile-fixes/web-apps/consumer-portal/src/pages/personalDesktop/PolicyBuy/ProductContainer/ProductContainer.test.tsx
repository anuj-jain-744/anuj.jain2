...
describe('ProductContainer Component', () => {
  ...
  test('renders ProductContainer with mocked ProductElements', () => {
    render(
      <Router>
        <ProductContainer languageData={{ buy_policy: 'Buy Policy', register_a_claim: 'Register a Claim', track_claim: 'Track Claim' }} />
      </Router>
    );
  ...
  test('renders correct text for each product', () => {
    ...
    expect(screen.getByText('Register a Claim')).toBeInTheDocument();
